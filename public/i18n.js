...
export const translationCatalogs = {
  en: {
    ...
    emoji: {
      ...
      customHelp: "PNG, JPEG, or WebP up to 512 KB.",
      customInvalidUrl: "Enter a valid HTTP or HTTPS image URL.",
      customInvalidFile: "Choose a PNG, JPEG, or WebP image.",
  ...
  ko: {
    ...
    emoji: {
      ...
      customHelp: "512KB 이하 PNG, JPEG 또는 WebP 파일을 사용할 수 있습니다.",
      customInvalidUrl: "올바른 HTTP 또는 HTTPS 이미지 URL을 입력하세요.",
      customInvalidFile: "PNG, JPEG 또는 WebP 이미지를 선택하세요.",

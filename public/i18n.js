...
export const translationCatalogs = {
  en: {
    ...
    account: {
      ...
      blockHistoryDescription: "Review sign-in attempts denied by your country access policy.",
      blockHistoryRefresh: "Refresh",
      blockHistoryPeriod: "History period",
      blockHistoryMonths: "Past {count} month(s)",
      blockHistoryTableCaption: "Recent country-policy login blocks",
      blockHistoryReason: "Reason",
      blockHistoryLoading: "Loading block history...",
      blockHistoryEmpty: "No country-policy blocks were recorded during this period.",
      ...
      blockHistoryPolicyInvalid: "Invalid policy",
      ...
      countryLoginSaved: "Country login access policy was updated.",

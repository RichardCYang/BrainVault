...
export const translationCatalogs = {
  en: {
    ...
    account: {
      ...
      themeTitle: "Theme",
      themeDescription: "Choose the color theme used across the entire workspace.",
      themeLight: "Light",
      themeDark: "Dark",
      securityTitle: "Security",
      securityDescription: "Manage authentication methods and review recent account access attempts.",
      securityTabsAria: "Security sections",
      securitySettingsTab: "Security settings",
      activeSessionsTab: "Logged-in devices",
      activeSessionsTitle: "Logged-in devices",
      activeSessionsDescription: "Review active browser sessions and sign out individual devices.",
      activeSessionsRefresh: "Refresh",
      activeSessionsTableCaption: "Active account sessions",
      activeSessionsDevice: "Device / browser",
      activeSessionsIp: "IP address",
      activeSessionsLastActive: "Last active",
      activeSessionsSignedIn: "Signed in",
      activeSessionsAction: "Action",
      activeSessionsCurrent: "This device",
      activeSessionsLoading: "Loading logged-in devices...",
      activeSessionsEmpty: "No active sessions were found.",
      activeSessionsSummary: "Active sessions · {count}",
      activeSessionsLogout: "Log out",
      activeSessionsLoggingOut: "Logging out...",
      activeSessionsLogoutConfirm: "Log out the {browser} session at {ip}?",
      activeSessionsCurrentLogoutConfirm: "Log out this device? Unsaved edits will be saved first and you will return to the login screen.",
      activeSessionLoggedOut: "The selected device was logged out.",
      activeSessionsDeviceDesktop: "Desktop",
      activeSessionsDeviceMobile: "Mobile",
      activeSessionsDeviceTablet: "Tablet",
      activeSessionsDeviceOther: "Other device",
      activeSessionsUnknownBrowser: "Unknown browser",
      activeSessionsUnknownOs: "Unknown OS",
      loginHistoryTab: "Login history",
      loginHistoryTitle: "Login history",
      loginHistoryDescription: "Review recent successful and failed sign-in attempts for your account.",
      loginHistoryRefresh: "Refresh",
      loginHistoryPeriod: "History period",
      loginHistoryMonths: "Past {count} month(s)",
      loginHistoryTableCaption: "Recent account login attempts",
      loginHistoryTime: "Time",
      loginHistoryIp: "IP address",
      loginHistoryCountry: "Country",
      loginHistoryUnknownCountry: "Unknown",
      loginHistoryResult: "Result",
      loginHistorySuccess: "Success",
      loginHistoryFailure: "Failed",
      loginHistoryLocked: "Locked",
      loginHistoryUnknownIp: "Unknown",
      loginHistoryLoading: "Loading login history...",
      loginHistoryEmpty: "No login attempts were recorded during this period.",
      loginHistoryTruncated: "Only the latest 500 attempts are shown.",
      loginHistorySummary: "Past {months} month(s) · {count} attempt(s)",
      blockHistoryTab: "Block history",
      blockHistoryTitle: "Block history",
      blockHistoryDescription: "Review sign-ins and authenticated sessions denied by country, VPN/proxy, or TOTP IP security policies.",
      blockHistoryRefresh: "Refresh",
      blockHistoryPeriod: "History period",
      blockHistoryMonths: "Past {count} month(s)",
      blockHistoryTableCaption: "Recent security-policy blocks",
      blockHistoryReason: "Reason",
      blockHistoryLoading: "Loading block history...",
      blockHistoryEmpty: "No security-policy blocks were recorded during this period.",
      blockHistoryTruncated: "Only the latest 500 blocks are shown.",
      blockHistorySummary: "Past {months} month(s) · {count} block(s)",
      blockHistoryNotAllowlisted: "Country not allowed",
      blockHistoryBlacklisted: "Blocked country",
      blockHistoryCountryUnresolved: "Country unresolved",
      blockHistoryPolicyInvalid: "Invalid policy", blockHistoryVpnDetected: "VPN detected", blockHistoryVpnGateDetected: "VPN Gate public relay detected", blockHistoryProxyDetected: "Proxy detected", blockHistoryTorDetected: "Tor exit detected", blockHistoryTotpAttemptsExceeded: "TOTP attempt limit exceeded",
      totpIpBlocksTab: "TOTP blocked IPs",
      totpIpBlockTitle: "TOTP attempt limit",
      totpIpBlockDescription: "Temporarily block TOTP code verification from a client IP after too many invalid authenticator-app codes.",
      totpIpBlockMode: "OTP attempt limiting", totpIpBlockOn: "On", totpIpBlockOff: "Off",
      totpIpBlockThreshold: "Allowed invalid TOTP attempts",
      totpIpBlockThresholdHint: "Default: 3. Reaching this number blocks TOTP verification from the IP for 24 hours.",
      totpIpBlockCurrentIp: "Current IP", totpIpBlockPassword: "Current password to save this policy",
      totpIpBlockWarning: "When enabled, invalid TOTP codes are accumulated for the same account and IP until a TOTP succeeds or this policy is changed. Reaching the configured limit blocks only TOTP verification from that IP for 24 hours; existing authenticated sessions and passkey sign-in remain available.",
      totpIpBlockSave: "Save OTP attempt limit", totpIpBlockSaving: "Saving...", totpIpBlockSaved: "TOTP IP attempt-limit policy was updated.",
      totpIpBlocksTitle: "Permanently blocked TOTP IPs",
      totpIpBlocksDescription: "Review and manually release IPs whose TOTP verification is temporarily blocked by this account's attempt limit.",
      totpIpBlocksRefresh: "Refresh", totpIpUnblockPassword: "Current password required to unblock",
      totpIpUnblockPasswordHint: "Enter your current password, then choose Unblock next to an IP.",
      totpIpBlocksTableCaption: "Active permanent TOTP IP blocks", totpIpBlocksAttempts: "Failed attempts", totpIpBlocksAction: "Action",
      totpIpBlocksEmpty: "No IPs are currently permanently blocked by the TOTP attempt limit.", totpIpBlocksLoading: "Loading permanently blocked IPs...",
      totpIpBlocksSummary: "Active permanent blocks · {count}", totpIpUnblock: "Unblock", totpIpUnblocking: "Unblocking...",
      totpIpUnblockPasswordRequired: "Enter your current password before unblocking an IP.",
      totpIpUnblockConfirm: "Unblock {ip}? Requests from this IP will be allowed again unless another account-level permanent block still applies.",
      totpIpUnblocked: "Unblocked {ip}.",
      countryLoginTitle: "IP country login access",
      countryLoginDescription: "Allow or deny sign-in based on the country resolved from the trusted client IP address.",
      countryLoginMode: "Access mode",
      countryLoginOff: "Off",
      countryLoginAllowlist: "Allowlist only",
      countryLoginBlocklist: "Blocklist",
      countryLoginCountry: "Country",
      countryLoginAdd: "Add",
      countryLoginCountryHint: "Choose countries used by the selected access mode.",
      countryLoginCurrentIp: "Current IP",
      countryLoginCurrentCountry: "Current country",
      countryLoginPassword: "Current password to save this policy",
      countryLoginWarning: "When enabled, sign-in is denied if the IP country cannot be determined. Saving also revokes other active sessions.",
      countryLoginSave: "Save country access policy",
      countryLoginNoCountries: "No countries selected.",
      countryLoginRemove: "Remove {country}",
      countryLoginCountriesRequired: "Select at least one country before enabling this policy.",
      countryLoginLoading: "Loading country access policy...",
      countryLoginSaving: "Saving...",
      countryLoginSaved: "Country login access policy was updated.", vpnBlockTitle: "VPN / proxy access blocking", vpnBlockDescription: "Block account access from high-confidence VPN, proxy, Tor exit, and verified VPN Gate public relay addresses.", vpnBlockMode: "VPN blocking", vpnBlockOn: "On", vpnBlockOff: "Off", vpnBlockCurrentIp: "Current IP", vpnBlockCurrentCountry: "Current country", vpnBlockCurrentVerdict: "Network assessment", vpnBlockCurrentSignals: "Supporting signals", vpnBlockRiskClear: "No VPN/proxy signal", vpnBlockRiskVpn: "VPN detected", vpnBlockRiskVpnGate: "VPN Gate relay detected", vpnBlockRiskProxy: "Proxy detected", vpnBlockRiskTor: "Tor exit detected", vpnBlockRiskUnknown: "Unavailable or ambiguous", vpnBlockRiskWithConfidence: "{risk} · confidence {confidence}%", vpnBlockProviderCount: "{count} source(s)", vpnBlockDatacenterSignal: "Data-center network", vpnBlockTimezoneSignal: "Browser/IP timezone offset differs", vpnBlockWebRtcMatchSignal: "WebRTC STUN IP matches HTTP IP", vpnBlockWebRtcMismatchSignal: "WebRTC STUN IP differs from HTTP IP ({ips})", vpnBlockWebRtcDisabledSignal: "WebRTC is disabled", vpnBlockWebRtcUnavailableSignal: "WebRTC STUN observation unavailable", vpnBlockVpnGateListed: "VPN Gate public relay directory match", vpnBlockVpnGateDdnsVerified: "VPN Gate relay + opengw.net DDNS verified", vpnBlockVpnGateProviderCorroborated: "VPN Gate relay + IP intelligence corroborated", vpnBlockVpnGateUnverified: "VPN Gate directory match not independently verified", vpnBlockNoSupportingSignals: "No supporting signal", vpnBlockPassword: "Current password to save this policy", vpnBlockWarning: "Detection uses free no-key network intelligence, the Tor exit list, and the VPN Gate public relay directory. VPN Gate entries are independently verified by opengw.net DDNS or IP intelligence before blocking; data-center and browser-timezone differences remain supporting signals only. Saving revokes other active sessions.", vpnBlockSave: "Save VPN blocking policy", vpnBlockLoading: "Checking network...", vpnBlockSaving: "Saving...", vpnBlockSaved: "VPN blocking policy was updated.",
      passwordTitle: "Password",
      passwordDescription: "Confirm your current password before choosing a new one.",
      currentPassword: "Current password",
      newPassword: "New password",
      confirmPassword: "Confirm new password",
      passwordHint: "Use at least 8 characters and no more than 72 UTF-8 bytes.",
      ...
      savingTheme: "Saving the theme preference...",
      themeSaved: "The workspace theme was updated.",
      passwordMismatch: "The new passwords do not match.",
      changingPassword: "Changing your password...",
      passwordChanged: "Your password was changed.",
      passwordChangedMfaReset: "Your password was changed. Existing two-step verification methods were reset and must be enrolled again."
    ,
      dataTitle: "Data",
      dataDescription: "Export or restore your complete BrainVault workspace.",
      exportTitle: "Export all data",
      exportDescription: "Download pages, collections, blocks, tags, sharing permissions, version history, navigation state, profile settings, and every attached file in one ZIP backup.",
      ...
      importWarning: "Restoring replaces the current workspace state in this account, including pages, blocks, tag links, sharing permissions, version history, navigation state, and attachments.",
      ...
      importConfirm: "Restore this backup? The current workspace state, including version history, navigation state, sharing permissions, and attachments, will be replaced.",
      importComplete: "Restore complete: {pages} pages, {blocks} blocks, {attachments} attachments, {shares} sharing permissions, {pageVersions} history entries, and {navigationCollapsedPages} collapsed navigation items."
    },
    mfa: {
      ...
      passkeyRegistrationTargetLabel: "Registration method",
      passkeyRegistrationAutomatic: "Automatic / this device",
      passkeyRegistrationRemote: "Phone or tablet by QR code",
      passkeyRegistrationAutomaticHint: "Use the normal browser chooser, or select QR registration to explicitly request a nearby phone or tablet.",
      passkeyRegistrationRemoteHint: "QR registration explicitly requests WebAuthn hybrid transport. Keep Bluetooth enabled on both devices and keep the phone near this device. If your passkey provider rejects remote creation, open BrainVault on the phone and create the passkey there instead.",
      ...
      passkeyHybridReady: "This browser reports that nearby-device (hybrid) passkeys are supported.",
      passkeyHybridUnknown: "This browser does not report hybrid capability. QR registration will still be attempted using the WebAuthn standard fallback.",
      passkeyHybridUnsupported: "This browser reports that nearby-device (hybrid) transport is unavailable. Try another current browser or create the passkey directly on the phone.",
      passwordRequired: "Enter your current password first.",
      stepUpTotpPrompt: "Enter a current 6-digit code from your existing authenticator to confirm this security change.",
      stepUpPasskeyPrompt: "Use an existing passkey to confirm this security change...",
      stepUpPasskeyRequired: "An existing passkey is required to confirm this security change in this browser.",
      stepUpRequired: "Confirm this security change with an existing two-step verification method.",
      ...
      passkeyAddingRemote: "Preparing nearby-device registration. Scan the browser QR code with your phone or tablet...",
      ...
      passkeyForegroundRequired: "Bring this BrainVault tab to the foreground, then press the passkey button again.",
      passkeyRemoteOperationCancelled: "QR passkey registration was cancelled, timed out, or rejected by the browser/provider. If your phone's passkey provider does not support remote creation, open BrainVault on the phone and create the passkey directly there.",
      passkeyRemoteUnsupported: "This browser or passkey provider does not support remote QR passkey creation. Create the passkey directly on the phone, then use it from other devices.",
      passkeySecurityError: "The browser rejected the WebAuthn security context. Check that BrainVault is served over HTTPS and that the configured WebAuthn RP ID matches this site's hostname.",
    ...
    emoji: {
      ...
      randomIcon: "Choose a random icon",
      ...
      iconResultCount: "{count} icons",
      customPreview: "Preview",
      customLibrary: "Saved custom icons",
      customLibraryResults: "Saved custom icons",
      customLibraryCount: "{count} saved",
      customLibraryItem: "Saved custom icon {index}",
      customLibraryRemove: "Remove saved custom icon {index}",
      customLibraryRemoveShort: "Remove from saved icons",
      customLibraryRemoveConfirm: "Remove this icon from your saved custom icons? Pages that already use it will not be changed.",
      customLibraryRemoved: "Removed from saved custom icons.",
      customLibraryRemoveError: "The custom icon could not be removed.",
      customLibraryEmpty: "Custom icons you use will appear here for quick reuse.",
      customUrlLabel: "Image URL",
      customUrlPlaceholder: "https://example.com/icon.png",
      customApply: "Use image URL",
      customOr: "or",
      customUpload: "Upload image",
      customHelp: "PNG, JPEG, WebP, or ICO up to 512 KB.",
      customInvalidUrl: "Enter a valid HTTP or HTTPS image URL.",
      customInvalidFile: "Choose a PNG, JPEG, WebP, or ICO image.",
      customTooLarge: "The image must be 512 KB or smaller.",
      customReading: "Reading image…",
      customReadError: "The image could not be read.",
      changeCollection: "Change collection icon",
      changePage: "Change page icon",
      collectionSaved: "The collection icon was updated.",
      pageSaved: "The page icon was updated."
    },
    home: {
    ...
    cover: {
      ...
      remove: "Remove",
      removeConfirm: "Remove this page cover? You can add it again later.",
      dialogKicker: "Page style",
      dialogTitle: "Choose a cover",
      dialogDescription: "Use a built-in cover or upload your own image.",
      close: "Close cover picker",
      defaultsAria: "Default cover images",
      defaultOption: "Default cover",
      customTitle: "Custom image",
      customHelp: "PNG, JPEG, or WebP. Large images are optimized before upload.",
      upload: "Upload image",
      positionAria: "Cover position controls",
      positionHelp: "Drag across the cover or use the sliders to choose its focal point.",
      horizontal: "Horizontal",
      vertical: "Vertical",
      cancel: "Cancel",
      applyPosition: "Apply position",
      applying: "Applying the cover...",
      applied: "The page cover was applied.",
      preparing: "Optimizing the cover image...",
      customApplied: "The custom cover was applied.",
      removed: "The page cover was removed.",
      positionSaved: "The cover position was saved.",
      invalidFile: "Choose a valid PNG, JPEG, or WebP image.",
      sourceTooLarge: "Choose an image smaller than 20 MB.",
      optimizedTooLarge: "The image could not be reduced below 2 MB. Choose a smaller image.",
      readError: "The cover image could not be read."
    },
    versions: {
      menu: "Version history",
      menuDescription: "See who changed this page and what changed.",
      kicker: "Page activity",
      title: "Version history",
      description: "Review who edited this page, when it happened, and exactly what changed.",
      close: "Close version history",
      listTitle: "All versions",
      loadMore: "Load older versions",
      reset: "Delete all history",
      resetConfirm: "Permanently delete every saved version for \"{title}\"? This cannot be undone. A new version 1 baseline will be created from the current page.",
      resetting: "Deleting all previous versions and creating version 1...",
      resetSuccess: "All previous history was deleted and the page was reset to version 1.",
      resetError: "Version history could not be reset.",
      selectTitle: "Select a version",
      selectDescription: "Choose an item to see the exact before and after values.",
      current: "Current revision {revision}",
      loading: "Loading version history...",
      empty: "No version history is available for this page yet.",
      loadError: "Version history could not be loaded.",
      detailsLoading: "Loading version details...",
      revision: "Version {revision}",
      pageVersion: "Page v{version}",
      contentVersion: "Content v{version}",
      historyStarted: "History tracking started",
      baselineDescription: "Existing page state when history tracking was enabled",
      pageCreated: "Page created",
      pageUpdated: "Page settings updated",
      contentChanged: "Page content updated",
      unknownActor: "Unknown user",
      actorDate: "{actors} · {date}",
      actorsMore: "{first} +{count}",
      noChanges: "No detailed changes were recorded.",
      changesCount: "{count} change(s)",
      summaryPageCreated: "Page created",
      summaryPageFields: "Page: {fields}",
      summaryBlocksCreated: "{count} block(s) added",
      summaryBlocksUpdated: "{count} block(s) changed",
      summaryBlocksDeleted: "{count} block(s) deleted",
      summaryBlocksMoved: "{count} block(s) moved",
      blockCreated: "Block added",
      blockDeleted: "Block deleted",
      blockUpdated: "Block updated",
      blockLabel: "{type} block",
      before: "Before",
      after: "After",
      emptyValue: "(empty)",
      yes: "Yes",
      ...
      fieldIcon: "Icon",
      fieldCoverUrl: "Cover",
      fieldCoverPositionX: "Cover horizontal position",
      fieldCoverPositionY: "Cover vertical position",
      fieldIsArchived: "Archived",
      fieldIsCollection: "Collection",
      fieldParentPageId: "Parent page",
      fieldTags: "Tags",
      fieldParentBlockId: "Parent block",
      fieldType: "Block type",
      fieldMarkdown: "Content",
      fieldChecked: "Checked",
      fieldSortOrder: "Order",
      fieldMetadata: "Structured data"
    },
    sharing: {
      button: "Share",
      kicker: "Real-time collaboration",
      title: "Share this page",
      description: "Add a BrainVault user by login ID. Shared users can edit this page with you in real time.",
      close: "Close sharing dialog",
      usernameLabel: "User login ID",
      usernamePlaceholder: "username",
      add: "Add user",
      remove: "Remove",
      peopleWithAccess: "People with access",
      count: "{count} shared user(s)",
      none: "Only you can access this page.",
      owner: "Owner",
      editor: "Can edit",
      adding: "Adding user...",
      added: "@{username} can now edit this page.",
      removing: "Removing @{username}...",
      removed: "@{username} no longer has access.",
      loading: "Loading shared users...",
      status: {
    ...
    aiChat: {
      ...
      titlePlaceholder: "AI conversation title",
      titleAria: "AI conversation block title",
      ...
      layoutLabel: "Display",
      layoutAria: "AI conversation display mode",
      layoutStacked: "Continuous",
      layoutPaginated: "Pages",
      hideAnswerBorder: "Hide AI answer border",
      paginationAria: "AI conversation pages",
      pageAria: "Show question and answer pair {count}",
      timeLabel: "Answered at",
      timeAria: "Date and time the AI answered",
      timeAriaNumbered: "Date and time for AI answer {count}",
      timeNotSet: "Answer time not set",
      turnLabel: "Turn {count}",
      addTurn: "+ Add next question and answer",
      addTurnTitle: "Add another question and answer pair",
      removeTurnNumbered: "Remove question and answer pair {count}",
    ...
    slash: {
      ...
      AI_CHAT: { label: "AI chat", hint: "Save consecutive AI question and answer pairs as chat bubbles", keywords: "ai chat conversation question answer model prompt" },
    ...
    database: {
      ...
      optionsTooMany: "A property can contain at most {count} options. Nothing was saved.",
      optionNameTooLong: "Each option name can contain at most {count} characters. Nothing was saved.",
      duplicateOption: "Duplicate option: {option}. Nothing was saved.",
      ambiguousOptionEdit: "Rename only one option at a time so existing row values can be preserved.",
      referencedOptionRemoval: "Cannot remove {option} while rows or filters still reference it.",
      invalidOptions: "These options cannot be saved without risking data loss.",
    ...
    kanban: {
      ...
      tagsAria: "Card tags",
      tooManyTags: "A card can contain at most {count} tags. Nothing was saved.",
      tagTooLong: "Each tag can contain at most {count} characters. Nothing was saved.",
      duplicateTags: "Duplicate tags are not allowed. Nothing was saved.",
    ...
    status: {
      ...
      creatingSubpage: "Creating a subpage...",
      subpageCreated: "Subpage created in read mode.",
      ...
      durableRecoveryStorageUnavailable: "Write mode is disabled because strict browser recovery storage is unavailable or has failed. No new edit was accepted.",
      sessionRecoveryStorageActive: "Write mode is enabled with strict session recovery storage. Persistent browser storage was not granted, so local crash-recovery data may be cleared when a private/incognito session ends; save or sync before closing it.",
      localRecoveryInspectionFailed: "Browser recovery storage could not be inspected safely. No destructive change was made. Keep every related tab open and try again.",
      exclusiveTransitionLockUnavailable: "This safety-critical operation requires the browser's cross-tab lock API, which is unavailable here. No destructive change was made. Use a supported browser over HTTPS and try again.",
      ...
      orphanedCollaborationRecovery: "Unconfirmed real-time edits for a deleted, unavailable, or no-longer-collaborative page were preserved. Copy the readable recovery data below before clearing browser storage.",
      serverRecoveryCandidates: "Recovery copies are safely stored on the server. Download any copy you need before removing it from the recovery vault.",
      destructiveCollaborationRecoveryPending: "This operation is blocked because {count} unconfirmed real-time recovery record(s) for affected pages remain in this browser. Reconnect every related tab and finish synchronization first.",
      workspaceLocalDraftsPending: "The backup is blocked because {count} unsaved local draft record(s) for owned pages remain in this browser. Let every related tab finish saving first.",
      destructiveLocalDraftsPending: "This operation is blocked because {count} unsaved local draft record(s) for affected pages remain in this browser. Let every related tab finish saving first.",
      workspaceTransitionBusy: "Another tab is deleting or restoring workspace data. Try again after that operation finishes.",
      ready: "Ready.",
    ...
    errors: {
      ...
      requestTimeout: "The server took too long to respond. The read request was retried automatically but still timed out. Please try again.",
      ...
      COUNTRY_LOGIN_BLOCKED: "Your current IP country is not permitted to sign in to or access this account.",
      COUNTRY_POLICY_WOULD_BLOCK_CURRENT_IP: "This policy would immediately block your current IP. Adjust the selected countries before saving.",
      VPN_ACCESS_BLOCKED: "VPN, proxy, or Tor access is blocked for this account.",
      VPN_POLICY_WOULD_BLOCK_CURRENT_IP: "This policy would immediately block your current IP. Disconnect the VPN/proxy before enabling it.",
      ...
      TOTP_IP_PERMANENTLY_BLOCKED: "TOTP code verification from this IP address is temporarily blocked after too many invalid codes. Existing sessions and passkey sign-in remain available.",
      MFA_STEP_UP_REQUIRED: "Confirm this security change with an existing two-step verification method.",
      MFA_STEP_UP_EXPIRED: "The two-step verification confirmation expired. Verify again.",
      TOTP_IP_BLOCK_NOT_FOUND: "That permanent TOTP IP block no longer exists.",
      ...
      PAGE_VERSION_RESET_CONFLICT: "This page or its version history changed in another session. The newer history was not reset. Review the refreshed history before trying again.",
  ...
  ja: {
    ...
    account: {
      ...
      preferencesTitle: "環境設定", preferencesDescription: "アカウントでのBrainVaultの表示と動作を選択します。", languageTitle: "言語", languageDescription: "サインイン時にこの言語を使用します。", themeTitle: "テーマ", themeDescription: "ワークスペース全体で使用する配色を選択します。", themeLight: "ライト", themeDark: "ダーク",
      securityTitle: "セキュリティ", securityDescription: "認証方法と最近のアカウントアクセス試行を確認します。", securityTabsAria: "セキュリティ項目", securitySettingsTab: "セキュリティ設定", loginHistoryTab: "ログイン履歴", loginHistoryTitle: "ログイン履歴", loginHistoryDescription: "アカウントへの最近のログイン成功・失敗を確認できます。", loginHistoryRefresh: "更新", loginHistoryPeriod: "表示期間", loginHistoryMonths: "過去{count}か月", loginHistoryTableCaption: "最近のアカウントログイン試行", loginHistoryTime: "日時", loginHistoryIp: "IPアドレス", loginHistoryCountry: "国", loginHistoryUnknownCountry: "不明", loginHistoryResult: "結果", loginHistorySuccess: "成功", loginHistoryFailure: "失敗", loginHistoryLocked: "ロック中", loginHistoryUnknownIp: "不明", loginHistoryLoading: "ログイン履歴を読み込んでいます...", loginHistoryEmpty: "この期間に記録されたログイン試行はありません。", loginHistoryTruncated: "最新500件のみ表示しています。", loginHistorySummary: "過去{months}か月・{count}件", blockHistoryTab: "ブロック履歴", blockHistoryTitle: "ブロック履歴", blockHistoryDescription: "国別またはVPN／プロキシのセキュリティポリシーで拒否された接続を確認します。", blockHistoryRefresh: "更新", blockHistoryPeriod: "表示期間", blockHistoryMonths: "過去{count}か月", blockHistoryTableCaption: "最近のセキュリティポリシーによるブロック", blockHistoryReason: "理由", blockHistoryLoading: "ブロック履歴を読み込んでいます...", blockHistoryEmpty: "この期間にセキュリティポリシーによるブロックはありません。", blockHistoryTruncated: "最新500件のみ表示しています。", blockHistorySummary: "過去{months}か月・{count}件", blockHistoryNotAllowlisted: "許可国ではありません", blockHistoryBlacklisted: "ブロック対象国", blockHistoryCountryUnresolved: "国を判定できません", blockHistoryPolicyInvalid: "無効なポリシー", blockHistoryVpnDetected: "VPNを検出", blockHistoryVpnGateDetected: "VPN Gate公開リレーを検出", blockHistoryProxyDetected: "プロキシを検出", blockHistoryTorDetected: "Tor出口を検出", countryLoginTitle: "IP国別ログイン制限", countryLoginDescription: "信頼済みクライアントIPから判定した国に基づいてログインを許可または拒否します。", countryLoginMode: "アクセスモード", countryLoginOff: "オフ", countryLoginAllowlist: "許可リストのみ", countryLoginBlocklist: "ブロックリスト", countryLoginCountry: "国", countryLoginAdd: "追加", countryLoginCountryHint: "選択したモードで使用する国を追加してください。", countryLoginCurrentIp: "現在のIP", countryLoginCurrentCountry: "現在の国", countryLoginPassword: "保存するには現在のパスワードを入力", countryLoginWarning: "有効時はIPの国を判定できない場合もログインを拒否します。保存すると他の有効なセッションも解除されます。", countryLoginSave: "国別アクセスポリシーを保存", countryLoginNoCountries: "国が選択されていません。", countryLoginRemove: "{country}を削除", countryLoginCountriesRequired: "有効にする前に1か国以上選択してください。", countryLoginLoading: "国別アクセスポリシーを読み込んでいます...", countryLoginSaving: "保存中...", countryLoginSaved: "国別ログインアクセスポリシーを更新しました。", vpnBlockTitle: "VPN / プロキシ接続ブロック", vpnBlockDescription: "高い確度でVPN、プロキシ、Tor出口と判定されたIPからのアカウントアクセスをブロックします。", vpnBlockMode: "VPNブロック", vpnBlockOn: "オン", vpnBlockOff: "オフ", vpnBlockCurrentIp: "現在のIP", vpnBlockCurrentCountry: "現在の国", vpnBlockCurrentVerdict: "ネットワーク判定", vpnBlockCurrentSignals: "補助シグナル", vpnBlockRiskClear: "VPN/プロキシのシグナルなし", vpnBlockRiskVpn: "VPNを検出", vpnBlockRiskVpnGate: "VPN Gateリレーを検出", vpnBlockRiskProxy: "プロキシを検出", vpnBlockRiskTor: "Tor出口を検出", vpnBlockRiskUnknown: "判定不能または不一致", vpnBlockRiskWithConfidence: "{risk}・信頼度 {confidence}%", vpnBlockProviderCount: "検証ソース {count}件", vpnBlockDatacenterSignal: "データセンターネットワーク", vpnBlockTimezoneSignal: "ブラウザ/IPのタイムゾーン差", vpnBlockWebRtcMatchSignal: "WebRTC STUN IPとHTTP IPが一致", vpnBlockWebRtcMismatchSignal: "WebRTC STUN IPがHTTP IPと異なる（{ips}）", vpnBlockWebRtcDisabledSignal: "WebRTCが無効", vpnBlockWebRtcUnavailableSignal: "WebRTC STUN観測を取得できません", vpnBlockVpnGateListed: "VPN Gate公開リレーディレクトリに一致", vpnBlockVpnGateDdnsVerified: "VPN Gateリレー + opengw.net DDNS検証済み", vpnBlockVpnGateProviderCorroborated: "VPN Gateリレー + IP情報で相互検証", vpnBlockVpnGateUnverified: "VPN Gate一覧一致（独立検証なし）", vpnBlockNoSupportingSignals: "補助シグナルなし", vpnBlockPassword: "保存するには現在のパスワードを入力", vpnBlockWarning: "無料・キー不要のネットワーク情報とTor出口リストを使用します。データセンター判定とブラウザのタイムゾーン差は補助シグナルとしてのみ使い、曖昧な結果はブロックしません。保存すると他の有効なセッションも解除されます。", vpnBlockSave: "VPNブロックポリシーを保存", vpnBlockLoading: "ネットワークを確認中...", vpnBlockSaving: "保存中...", vpnBlockSaved: "VPNブロックポリシーを更新しました。", passwordTitle: "パスワード", passwordDescription: "新しいパスワードを設定する前に現在のパスワードを確認します。", currentPassword: "現在のパスワード", newPassword: "新しいパスワード", confirmPassword: "新しいパスワードを確認", passwordHint: "8文字以上、かつUTF-8で72バイト以内にしてください。", changePassword: "パスワードを変更",
      preparingAvatar: "プロフィール写真を準備しています...", avatarReady: "新しいプロフィール写真を保存できます。", avatarRemoved: "保存するとプロフィール写真が削除されます。", invalidAvatar: "有効なPNG、JPG、WebP画像を選択してください。", avatarTooLarge: "画像が大きすぎます。5MB未満のファイルを選択してください。", savingProfile: "プロフィールを保存しています...", profileSaved: "プロフィールを更新しました。", savingLanguage: "言語設定を保存しています...", savingTheme: "テーマ設定を保存しています...", themeSaved: "ワークスペースのテーマを更新しました。", passwordMismatch: "新しいパスワードが一致しません。", changingPassword: "パスワードを変更しています...", passwordChanged: "パスワードを変更しました。"
    ,
      dataTitle: "データ",
      dataDescription: "BrainVaultワークスペース全体を書き出しまたは復元します。",
      exportTitle: "すべてのデータを書き出す",
      exportDescription: "ページ、コレクション、ブロック、タグ、共有権限、バージョン履歴、ナビゲーション状態、プロフィール設定、添付ファイルを1つのZIPバックアップとしてダウンロードします。",
      exportButton: "ZIPバックアップを書き出す",
      importTitle: "バックアップを復元",
      importDescription: "BrainVaultから書き出したZIPを検証して復元します。パスワードと2段階認証は変更されません。",
      importWarning: "復元すると、ページ、ブロック、タグ関連付け、共有権限、バージョン履歴、ナビゲーション状態、添付ファイルを含む、このアカウントの現在のワークスペース状態が置き換わります。",
      ...
      importConfirm: "このバックアップを復元しますか？バージョン履歴、ナビゲーション状態、共有権限、添付ファイルを含む現在のワークスペース状態が置き換わります。",
      importComplete: "復元完了: ページ{pages}件、ブロック{blocks}件、添付{attachments}件、共有権限{shares}件、履歴{pageVersions}件、ナビゲーション折りたたみ{navigationCollapsedPages}件。"
    },
    search: {
    ...
    sharing: {
      ...
      kicker: "リアルタイム共同編集",
      title: "このページを共有",
      description: "BrainVault のログイン ID でユーザーを追加します。共有ユーザーはこのページをリアルタイムで一緒に編集できます。",
      close: "共有ダイアログを閉じる",
      usernameLabel: "ユーザーのログイン ID",
      usernamePlaceholder: "ユーザー名",
      add: "ユーザーを追加",
      remove: "削除",
      peopleWithAccess: "アクセスできるユーザー",
      count: "共有ユーザー {count} 人",
      none: "現在、このページにアクセスできるのは自分だけです。",
      owner: "所有者",
      editor: "編集可能",
      adding: "ユーザーを追加しています...",
      added: "@{username} がこのページを編集できるようになりました。",
      removing: "@{username} を削除しています...",
      removed: "@{username} のアクセス権を削除しました。",
      loading: "共有ユーザーを読み込んでいます...",
      status: {
        connecting: "接続中",
        syncing: "同期中",
        synced: "ライブ",
      ...
      activeEditors: "共同編集中のユーザー {count} 人",
      remoteEditing: "{name} が編集中",
      syncRequired: "リアルタイム文書の同期が完了するまでお待ちください。",
      accessChanged: "この共有ページへのアクセス権が変更されました。"
    },
    menu: {
    ...
    kanban: {
      ...
      tagsAria: "カードのタグ",
      tooManyTags: "1枚のカードに設定できるタグは最大{count}個です。保存していません。",
      tagTooLong: "各タグは最大{count}文字です。保存していません。",
      duplicateTags: "重複するタグは使用できません。保存していません。",
    ...
    status: {
      ...
      creatingSubpage: "サブページを作成しています...",
      subpageCreated: "サブページを作成しました。",
      ...
      durableRecoveryStorageUnavailable: "厳格なブラウザー復旧用ストレージが利用できないか書き込みに失敗したため、編集モードを無効にしました。新しい編集内容は受け付けていません。",
      sessionRecoveryStorageActive: "厳格なセッション復旧用ストレージで編集モードを有効にしました。永続ストレージは許可されていないため、プライベート／シークレット セッションを閉じるとローカル復旧データが消去される場合があります。閉じる前に保存または同期してください。",
      localRecoveryInspectionFailed: "ブラウザーの復旧用保存領域を安全に確認できなかったため、破壊的な変更は実行しませんでした。関連するすべてのタブを開いたまま、もう一度お試しください。",
      exclusiveTransitionLockUnavailable: "この安全上重要な操作にはブラウザーのタブ間ロック API が必要ですが、現在の環境では利用できません。破壊的な変更は実行されませんでした。HTTPS 上で対応ブラウザーを使用して再試行してください。",
      orphanedLocalDrafts: "別のタブまたは以前のセッションに残っていた、削除済みまたは現在利用できないページの未保存変更を保護しました。ブラウザーの保存データを消去する前に、以下の復旧データをコピーしてください。",
      orphanedCollaborationRecovery: "削除済み、利用不可、または共同編集が解除されたページの、サーバー未確認のリアルタイム編集を保護しました。ブラウザーの保存データを消去する前に、以下の読み取り可能な復旧データをコピーしてください。",
      serverRecoveryCandidates: "復旧コピーはサーバーに安全に保存されています。復旧保管庫から削除する前に、必要なコピーをダウンロードしてください。",
      destructiveCollaborationRecoveryPending: "影響を受けるページについて、サーバー未確認のリアルタイム復旧レコードがこのブラウザーに {count} 件残っているため、この操作は実行できません。関連するすべてのタブを再接続して同期を完了してください。",
      workspaceLocalDraftsPending: "所有ページの未保存ローカル下書きがこのブラウザーに {count} 件残っているため、バックアップを作成できません。関連するすべてのタブで保存を完了してください。",
      destructiveLocalDraftsPending: "影響を受けるページの未保存ローカル下書きがこのブラウザーに {count} 件残っているため、この操作を実行できません。関連するすべてのタブで保存を完了してください。",
      workspaceTransitionBusy: "別のタブでワークスペースの削除または復元が進行中です。完了後にもう一度お試しください。",
      ready: "準備ができました。",
    ...
    errors: {
      ...
      requestTimeout: "サーバーの応答に時間がかかりすぎました。読み取りリクエストを自動で再試行しましたが、タイムアウトしました。もう一度お試しください。",
      ...
      COUNTRY_LOGIN_BLOCKED: "現在のIPの国からはこのアカウントにログインまたはアクセスできません。",
      COUNTRY_POLICY_WOULD_BLOCK_CURRENT_IP: "この設定では現在のIPが直ちにブロックされます。国の設定を調整してから保存してください。",
      VPN_ACCESS_BLOCKED: "このアカウントではVPN、プロキシ、Torからのアクセスがブロックされています。",
      VPN_POLICY_WOULD_BLOCK_CURRENT_IP: "この設定では現在のIPが直ちにブロックされます。VPN/プロキシを切断してから有効にしてください。",
  ...
  ko: {
    ...
    account: {
      ...
      preferencesTitle: "환경설정", preferencesDescription: "계정에서 사용할 BrainVault의 표시와 동작을 설정하세요.", languageTitle: "언어", languageDescription: "로그인할 때마다 이 언어를 사용합니다.", themeTitle: "테마", themeDescription: "전체 워크스페이스에 적용할 색상 테마를 선택하세요.", themeLight: "일반 테마", themeDark: "다크 테마",
      securityTitle: "보안", securityDescription: "인증 수단을 관리하고 최근 계정 접속 시도를 확인합니다.", securityTabsAria: "보안 항목", securitySettingsTab: "보안 설정", activeSessionsTab: "로그인된 기기", activeSessionsTitle: "로그인된 기기", activeSessionsDescription: "현재 살아있는 브라우저 세션과 접속 IP를 확인하고 기기별로 로그아웃할 수 있습니다.", activeSessionsRefresh: "새로고침", activeSessionsTableCaption: "현재 활성 로그인 세션", activeSessionsDevice: "기기 / 브라우저", activeSessionsIp: "IP 주소", activeSessionsLastActive: "최근 활동", activeSessionsSignedIn: "로그인 시각", activeSessionsAction: "작업", activeSessionsCurrent: "현재 기기", activeSessionsLoading: "로그인된 기기를 불러오는 중입니다...", activeSessionsEmpty: "현재 활성 로그인 세션이 없습니다.", activeSessionsSummary: "현재 활성 세션 · 총 {count}개", activeSessionsLogout: "로그아웃", activeSessionsLoggingOut: "로그아웃 중...", activeSessionsLogoutConfirm: "{ip}에서 접속한 {browser} 세션을 로그아웃할까요?", activeSessionsCurrentLogoutConfirm: "현재 기기에서 로그아웃할까요? 저장되지 않은 편집 내용을 먼저 저장한 뒤 로그인 화면으로 이동합니다.", activeSessionLoggedOut: "선택한 기기 세션을 로그아웃했습니다.", activeSessionsDeviceDesktop: "데스크톱", activeSessionsDeviceMobile: "모바일", activeSessionsDeviceTablet: "태블릿", activeSessionsDeviceOther: "기타 기기", activeSessionsUnknownBrowser: "알 수 없는 브라우저", activeSessionsUnknownOs: "알 수 없는 운영체제", loginHistoryTab: "로그인 기록", loginHistoryTitle: "로그인 기록", loginHistoryDescription: "내 계정의 최근 로그인 성공 및 실패 시도를 확인합니다.", loginHistoryRefresh: "새로고침", loginHistoryPeriod: "조회 기간", loginHistoryMonths: "최근 {count}개월", loginHistoryTableCaption: "최근 계정 로그인 시도", loginHistoryTime: "시도 일시", loginHistoryIp: "IP 주소", loginHistoryCountry: "국가", loginHistoryUnknownCountry: "알 수 없음", loginHistoryResult: "결과", loginHistorySuccess: "성공", loginHistoryFailure: "실패", loginHistoryLocked: "잠김", loginHistoryUnknownIp: "알 수 없음", loginHistoryLoading: "로그인 기록을 불러오는 중입니다...", loginHistoryEmpty: "선택한 기간에 기록된 로그인 시도가 없습니다.", loginHistoryTruncated: "최신 500건까지만 표시합니다.", loginHistorySummary: "최근 {months}개월 · 총 {count}건", blockHistoryTab: "차단 기록", blockHistoryTitle: "차단 기록", blockHistoryDescription: "국가·VPN/프록시 또는 TOTP IP 보안 정책 때문에 거부된 로그인 및 인증 접속을 확인합니다.", blockHistoryRefresh: "새로고침", blockHistoryPeriod: "조회 기간", blockHistoryMonths: "최근 {count}개월", blockHistoryTableCaption: "최근 보안 정책 차단 기록", blockHistoryReason: "차단 사유", blockHistoryLoading: "차단 기록을 불러오는 중입니다...", blockHistoryEmpty: "선택한 기간에 보안 정책으로 차단된 기록이 없습니다.", blockHistoryTruncated: "최신 500건까지만 표시합니다.", blockHistorySummary: "최근 {months}개월 · 총 {count}건", blockHistoryNotAllowlisted: "허용 국가 아님", blockHistoryBlacklisted: "차단 국가", blockHistoryCountryUnresolved: "국가 판별 실패", blockHistoryPolicyInvalid: "정책 설정 오류", blockHistoryVpnDetected: "VPN 감지", blockHistoryVpnGateDetected: "VPN Gate 공개 릴레이 감지", blockHistoryProxyDetected: "프록시 감지", blockHistoryTorDetected: "Tor 출구 감지", blockHistoryTotpAttemptsExceeded: "TOTP 허용 횟수 초과", totpIpBlocksTab: "TOTP 차단 IP", totpIpBlockTitle: "TOTP 횟수 제한", totpIpBlockDescription: "인증 앱 TOTP를 설정 횟수 이상 틀리면 해당 클라이언트 IP를 영구 차단합니다.", totpIpBlockMode: "OTP 횟수 제한", totpIpBlockOn: "사용", totpIpBlockOff: "사용 안 함", totpIpBlockThreshold: "허용 TOTP 실패 횟수", totpIpBlockThresholdHint: "기본값은 3회입니다. 이 횟수에 도달하는 실패 시 해당 IP가 영구 차단됩니다.", totpIpBlockCurrentIp: "현재 IP", totpIpBlockPassword: "정책 저장을 위한 현재 비밀번호", totpIpBlockWarning: "활성화하면 같은 계정·IP의 TOTP 실패를 올바른 TOTP 인증에 성공하거나 이 정책을 변경할 때까지 누적합니다. 설정 횟수에 도달하면 서버가 로그인 화면과 API를 제공하기 전에 해당 IP를 영구 차단합니다. 기존 영구 차단은 이 정책을 꺼도 유지되며 직접 해제해야 합니다.", totpIpBlockSave: "OTP 횟수 제한 저장", totpIpBlockSaving: "저장 중...", totpIpBlockSaved: "TOTP IP 횟수 제한 정책을 변경했습니다.", totpIpBlocksTitle: "TOTP 영구 차단 IP 목록", totpIpBlocksDescription: "차단되지 않은 다른 네트워크에서 접속해 이 계정의 TOTP 횟수 제한으로 영구 차단된 IP를 확인하고 직접 해제할 수 있습니다.", totpIpBlocksRefresh: "새로고침", totpIpUnblockPassword: "차단 해제용 현재 비밀번호", totpIpUnblockPasswordHint: "현재 비밀번호를 입력한 뒤 해제할 IP의 ‘차단 해제’를 누르세요.", totpIpBlocksTableCaption: "현재 TOTP 영구 차단 IP", totpIpBlocksAttempts: "실패 횟수", totpIpBlocksAction: "작업", totpIpBlocksEmpty: "현재 TOTP 횟수 제한으로 영구 차단된 IP가 없습니다.", totpIpBlocksLoading: "영구 차단 IP를 불러오는 중입니다...", totpIpBlocksSummary: "현재 영구 차단 · 총 {count}건", totpIpUnblock: "차단 해제", totpIpUnblocking: "해제 중...", totpIpUnblockPasswordRequired: "IP 차단을 해제하려면 현재 비밀번호를 입력하세요.", totpIpUnblockConfirm: "{ip} 차단을 해제할까요? 다른 계정 수준의 영구 차단이 없다면 이 IP의 서버 접속이 다시 허용됩니다.", totpIpUnblocked: "{ip} 차단을 해제했습니다.", countryLoginTitle: "IP 국가별 로그인 제한", countryLoginDescription: "신뢰된 클라이언트 IP에서 판별한 국가를 기준으로 로그인을 허용하거나 차단합니다.", countryLoginMode: "접근 방식", countryLoginOff: "사용 안 함", countryLoginAllowlist: "화이트리스트 국가만 허용", countryLoginBlocklist: "블랙리스트 국가 차단", countryLoginCountry: "국가", countryLoginAdd: "추가", countryLoginCountryHint: "선택한 접근 방식에 적용할 국가를 추가하세요.", countryLoginCurrentIp: "현재 IP", countryLoginCurrentCountry: "현재 국가", countryLoginPassword: "정책 저장을 위한 현재 비밀번호", countryLoginWarning: "활성화하면 IP 국가를 판별할 수 없는 경우에도 로그인이 차단됩니다. 저장 시 다른 활성 로그인 세션도 해제됩니다.", countryLoginSave: "국가별 접근 정책 저장", countryLoginNoCountries: "선택한 국가가 없습니다.", countryLoginRemove: "{country} 제거", countryLoginCountriesRequired: "정책을 활성화하려면 국가를 1개 이상 선택하세요.", countryLoginLoading: "국가별 접근 정책을 불러오는 중입니다...", countryLoginSaving: "저장 중...", countryLoginSaved: "국가별 로그인 접근 정책을 변경했습니다.", vpnBlockTitle: "VPN / 프록시 접속 차단", vpnBlockDescription: "고신뢰 VPN·프록시·Tor 출구 및 검증된 VPN Gate 공개 릴레이 IP의 계정 접속을 차단합니다.", vpnBlockMode: "VPN 차단", vpnBlockOn: "사용", vpnBlockOff: "사용 안 함", vpnBlockCurrentIp: "현재 IP", vpnBlockCurrentCountry: "현재 국가", vpnBlockCurrentVerdict: "네트워크 판정", vpnBlockCurrentSignals: "보조 신호", vpnBlockRiskClear: "VPN/프록시 신호 없음", vpnBlockRiskVpn: "VPN 감지", vpnBlockRiskVpnGate: "VPN Gate 릴레이 감지", vpnBlockRiskProxy: "프록시 감지", vpnBlockRiskTor: "Tor 출구 감지", vpnBlockRiskUnknown: "판정 불가 또는 소스 불일치", vpnBlockRiskWithConfidence: "{risk} · 신뢰도 {confidence}%", vpnBlockProviderCount: "검증 소스 {count}개", vpnBlockDatacenterSignal: "데이터센터 네트워크", vpnBlockTimezoneSignal: "브라우저/IP 시간대 오프셋 차이", vpnBlockWebRtcMatchSignal: "WebRTC STUN IP와 HTTP IP 일치", vpnBlockWebRtcMismatchSignal: "WebRTC STUN IP가 HTTP IP와 다름 ({ips})", vpnBlockWebRtcDisabledSignal: "WebRTC 비활성화", vpnBlockWebRtcUnavailableSignal: "WebRTC STUN 관측 불가", vpnBlockVpnGateListed: "VPN Gate 공개 릴레이 목록 일치", vpnBlockVpnGateDdnsVerified: "VPN Gate 릴레이 + opengw.net DDNS 검증", vpnBlockVpnGateProviderCorroborated: "VPN Gate 릴레이 + IP 인텔리전스 교차검증", vpnBlockVpnGateUnverified: "VPN Gate 목록 일치(독립 검증 실패)", vpnBlockNoSupportingSignals: "추가 보조 신호 없음", vpnBlockPassword: "정책 저장을 위한 현재 비밀번호", vpnBlockWarning: "무료·무키 네트워크 인텔리전스, Tor 출구 목록, VPN Gate 공개 릴레이 목록을 사용합니다. VPN Gate 목록은 opengw.net DDNS 또는 독립 IP 인텔리전스로 추가 검증된 경우에만 차단하며, 데이터센터 여부와 브라우저 시간대 차이는 보조 신호로만 사용합니다. 저장 시 다른 활성 세션도 해제됩니다.", vpnBlockSave: "VPN 차단 정책 저장", vpnBlockLoading: "네트워크 판정 중...", vpnBlockSaving: "저장 중...", vpnBlockSaved: "VPN 차단 정책을 변경했습니다.", passwordTitle: "비밀번호", passwordDescription: "새 비밀번호를 설정하기 전에 현재 비밀번호를 확인합니다.", currentPassword: "현재 비밀번호", newPassword: "새 비밀번호", confirmPassword: "새 비밀번호 확인", passwordHint: "8자 이상, UTF-8 기준 72바이트 이하로 입력하세요.", changePassword: "비밀번호 변경",
      preparingAvatar: "프로필 사진을 준비하고 있습니다...", avatarReady: "새 프로필 사진을 저장할 준비가 되었습니다.", avatarRemoved: "저장하면 프로필 사진이 삭제됩니다.", invalidAvatar: "올바른 PNG, JPG 또는 WebP 이미지를 선택하세요.", avatarTooLarge: "이미지가 너무 큽니다. 5MB 미만 파일을 선택하세요.", savingProfile: "프로필을 저장하고 있습니다...", profileSaved: "프로필을 업데이트했습니다.", savingLanguage: "언어 설정을 저장하고 있습니다...", savingTheme: "테마 설정을 저장하고 있습니다...", themeSaved: "전체 워크스페이스 테마를 변경했습니다.", passwordMismatch: "새 비밀번호가 서로 일치하지 않습니다.", changingPassword: "비밀번호를 변경하고 있습니다...", passwordChanged: "비밀번호를 변경했습니다."
    ,
      dataTitle: "데이터",
      dataDescription: "BrainVault 워크스페이스 전체를 내보내거나 복원합니다.",
      exportTitle: "모든 데이터 내보내기",
      exportDescription: "페이지, 컬렉션, 블록, 태그, 공유 권한, 버전 기록, 내비게이션 접힘 상태, 프로필 설정과 모든 첨부파일 원본을 하나의 ZIP 백업으로 내려받습니다.",
      exportButton: "ZIP 백업 내보내기",
      importTitle: "백업 복원",
      importDescription: "BrainVault에서 내보낸 ZIP 백업을 검증한 뒤 원본 상태로 복원합니다. 비밀번호와 2단계 인증은 변경하지 않습니다.",
      importWarning: "복원하면 페이지, 블록, 태그 연결, 공유 권한, 버전 기록, 내비게이션 접힘 상태와 첨부파일을 포함한 이 계정의 현재 워크스페이스 상태가 백업 내용으로 교체됩니다.",
      ...
      importConfirm: "이 백업을 복원할까요? 버전 기록, 내비게이션 접힘 상태, 공유 권한과 첨부파일을 포함한 현재 워크스페이스 상태가 모두 교체됩니다.",
      importComplete: "복원이 완료되었습니다: 페이지 {pages}개, 블록 {blocks}개, 첨부파일 {attachments}개, 공유 권한 {shares}개, 버전 기록 {pageVersions}개, 내비게이션 접힘 {navigationCollapsedPages}개."
    },
    mfa: {
      ...
      passkeyTitle: "패스키(WebAuthn/FIDO2)", passkeyDescription: "기기 또는 하드웨어 보안키를 여러 개 등록할 수 있습니다.", passkeyNameLabel: "패스키 이름", passkeyNamePlaceholder: "노트북, 휴대폰, 백업키…",
      passkeyRegistrationTargetLabel: "등록 방식", passkeyRegistrationAutomatic: "자동 선택 / 현재 기기", passkeyRegistrationRemote: "휴대폰·태블릿 QR 등록",
      passkeyRegistrationAutomaticHint: "일반 브라우저 선택 창을 사용합니다. 휴대폰이나 태블릿에 QR로 새 패스키를 만들려면 QR 등록을 선택하세요.",
      passkeyRegistrationRemoteHint: "QR 등록은 WebAuthn hybrid 전송을 명시적으로 요청합니다. 두 기기의 Bluetooth를 켜고 가까이 두세요. 패스키 제공자가 원격 생성을 거부하면 휴대폰에서 BrainVault를 직접 열어 그 기기에서 패스키를 생성하세요.", addPasskey: "패스키 추가",
      ...
      passkeyHybridReady: "이 브라우저는 근처 기기(hybrid) 패스키를 지원한다고 보고합니다.",
      passkeyHybridUnknown: "이 브라우저는 hybrid 지원 여부를 보고하지 않습니다. 그래도 WebAuthn 표준 호환 경로로 QR 등록을 시도합니다.",
      passkeyHybridUnsupported: "이 브라우저는 근처 기기(hybrid) 전송을 지원하지 않는다고 보고합니다. 최신 브라우저를 사용하거나 휴대폰에서 직접 패스키를 생성하세요.",
      ...
      passkeyAdding: "브라우저 안내에 따라 패스키를 등록하세요...", passkeyAddingRemote: "근처 기기 등록을 준비했습니다. 브라우저에 표시된 QR 코드를 휴대폰이나 태블릿으로 스캔하세요...", passkeyAdded: "패스키를 추가했습니다.", passkeyRemoved: "패스키를 삭제했습니다.", passkeyRenamed: "패스키 이름을 변경했습니다.",
      verifying: "2단계 인증을 확인하고 있습니다...", passkeyAuthenticating: "등록된 패스키로 본인 확인을 진행하세요...",
      passkeyOperationCancelled: "패스키 요청이 취소되었거나 시간이 초과되었습니다.",
      passkeyForegroundRequired: "이 BrainVault 탭을 전면에 둔 뒤 패스키 버튼을 다시 눌러 주세요.",
      passkeyRemoteOperationCancelled: "QR 패스키 등록이 취소·시간 초과되었거나 브라우저/패스키 제공자에서 거부되었습니다. 휴대폰의 패스키 제공자가 원격 생성을 지원하지 않으면 휴대폰에서 BrainVault를 직접 열어 패스키를 생성하세요.",
      passkeyRemoteUnsupported: "이 브라우저 또는 패스키 제공자는 원격 QR 패스키 생성을 지원하지 않습니다. 휴대폰에서 직접 패스키를 만든 뒤 다른 기기에서 사용하세요.",
      passkeySecurityError: "브라우저가 WebAuthn 보안 컨텍스트를 거부했습니다. BrainVault가 HTTPS로 제공되는지, WebAuthn RP ID가 현재 사이트 호스트명과 일치하는지 확인하세요.",
      sessionExpired: "2단계 인증 시간이 만료되었습니다. 다시 로그인하세요.", totpSetupExpired: "인증 앱 설정을 다시 시작하세요.",
    ...
    emoji: {
      ...
      iconSearchLabel: "아이콘 검색",
      iconSearchPlaceholder: "아이콘 필터",
      random: "무작위 이모지 선택",
      randomIcon: "무작위 아이콘 선택",
      skinTone: "피부 톤 선택",
      ...
      results: "이모지 검색 결과",
      iconResults: "아이콘 검색 결과",
      empty: "검색 결과가 없습니다.",
      iconEmpty: "일치하는 아이콘이 없습니다.",
      help: "이모지 모양은 운영체제에 따라 다르게 보일 수 있습니다.",
      reset: "제거",
      searchResults: "검색 결과",
      resultCount: "이모지 {count}개",
      iconResultCount: "아이콘 {count}개",
      customPreview: "미리보기",
      customLibrary: "사용자 지정 아이콘 모음",
      customLibraryResults: "저장한 사용자 지정 아이콘",
      customLibraryCount: "{count}개 저장됨",
      customLibraryItem: "저장한 사용자 지정 아이콘 {index}",
      customLibraryRemove: "저장한 사용자 지정 아이콘 {index} 제거",
      customLibraryRemoveShort: "저장 목록에서 제거",
      customLibraryRemoveConfirm: "이 아이콘을 저장한 사용자 지정 아이콘 목록에서 제거할까요? 이미 이 아이콘을 사용 중인 페이지는 변경되지 않습니다.",
      customLibraryRemoved: "저장한 사용자 지정 아이콘 목록에서 제거했습니다.",
      customLibraryRemoveError: "사용자 지정 아이콘을 제거하지 못했습니다.",
      customLibraryEmpty: "한 번 사용한 사용자 지정 아이콘이 여기에 저장되어 바로 다시 사용할 수 있습니다.",
      customUrlLabel: "이미지 URL",
      customUrlPlaceholder: "https://example.com/icon.png",
      customApply: "이미지 URL 사용",
      customOr: "또는",
      customUpload: "이미지 업로드",
      customHelp: "512KB 이하 PNG, JPEG, WebP 또는 ICO 파일을 사용할 수 있습니다.",
      customInvalidUrl: "올바른 HTTP 또는 HTTPS 이미지 URL을 입력하세요.",
      customInvalidFile: "PNG, JPEG, WebP 또는 ICO 이미지를 선택하세요.",
      customTooLarge: "이미지는 512KB 이하여야 합니다.",
      customReading: "이미지를 읽는 중…",
      customReadError: "이미지 파일을 읽지 못했습니다.",
      changeCollection: "컬렉션 아이콘 변경",
      changePage: "페이지 아이콘 변경",
      collectionSaved: "컬렉션 아이콘을 변경했습니다.",
      pageSaved: "페이지 아이콘을 변경했습니다."
    },
    home: {
    ...
    cover: {
      regionAria: "페이지 커버",
      alt: "{title} 페이지의 커버 이미지",
      add: "커버 추가",
      change: "커버 변경",
      reposition: "위치 조절",
      remove: "커버 삭제",
      removeConfirm: "이 페이지의 커버를 삭제할까요? 나중에 다시 추가할 수 있습니다.",
      dialogKicker: "페이지 스타일",
      dialogTitle: "커버 선택",
      dialogDescription: "기본 커버를 사용하거나 원하는 이미지를 업로드하세요.",
      close: "커버 선택 창 닫기",
      defaultsAria: "기본 커버 이미지",
      defaultOption: "기본 커버",
      customTitle: "커스텀 이미지",
      customHelp: "PNG, JPEG 또는 WebP 이미지를 사용할 수 있습니다. 큰 이미지는 업로드 전에 자동 최적화됩니다.",
      upload: "이미지 업로드",
      positionAria: "커버 위치 조절",
      positionHelp: "커버를 드래그하거나 슬라이더를 움직여 중심 위치를 지정하세요.",
      horizontal: "가로 위치",
      vertical: "세로 위치",
      cancel: "취소",
      applyPosition: "위치 적용",
      applying: "커버를 적용하는 중입니다...",
      applied: "페이지 커버를 적용했습니다.",
      preparing: "커버 이미지를 최적화하는 중입니다...",
      customApplied: "커스텀 커버를 적용했습니다.",
      removed: "페이지 커버를 삭제했습니다.",
      positionSaved: "커버 위치를 저장했습니다.",
      invalidFile: "올바른 PNG, JPEG 또는 WebP 이미지를 선택하세요.",
      sourceTooLarge: "20MB보다 작은 이미지를 선택하세요.",
      optimizedTooLarge: "이미지를 2MB 이하로 줄이지 못했습니다. 더 작은 이미지를 선택하세요.",
      readError: "커버 이미지를 읽지 못했습니다."
    },
    versions: {
      menu: "페이지 버전 정보",
      menuDescription: "누가 언제 무엇을 수정했는지 확인합니다.",
      kicker: "페이지 활동",
      title: "페이지 버전 이력",
      description: "이 페이지를 누가 언제 수정했는지와 변경 전·후 내용을 자세히 확인하세요.",
      close: "페이지 버전 이력 닫기",
      listTitle: "전체 수정 내역",
      loadMore: "이전 버전 더 불러오기",
      reset: "전체 기록 삭제",
      resetConfirm: "\"{title}\" 페이지의 모든 버전 기록을 영구 삭제할까요? 이 작업은 되돌릴 수 없으며 현재 페이지 상태를 기준으로 버전 1이 새로 생성됩니다.",
      resetting: "이전 버전 기록을 모두 삭제하고 버전 1을 생성하는 중입니다...",
      resetSuccess: "모든 이전 기록을 삭제하고 버전 1로 초기화했습니다.",
      resetError: "버전 기록을 초기화하지 못했습니다.",
      selectTitle: "버전을 선택하세요",
      selectDescription: "항목을 선택하면 정확한 변경 전·후 값을 볼 수 있습니다.",
      current: "현재 리비전 {revision}",
      loading: "버전 이력을 불러오는 중입니다...",
      empty: "아직 이 페이지의 버전 이력이 없습니다.",
      loadError: "버전 이력을 불러오지 못했습니다.",
      detailsLoading: "상세 수정 내역을 불러오는 중입니다...",
      revision: "버전 {revision}",
      pageVersion: "페이지 v{version}",
      contentVersion: "콘텐츠 v{version}",
      historyStarted: "수정 이력 기록 시작",
      baselineDescription: "수정 이력 기능이 적용된 시점의 기존 페이지 상태",
      pageCreated: "페이지 생성",
      pageUpdated: "페이지 설정 수정",
      contentChanged: "페이지 내용 수정",
      unknownActor: "알 수 없는 사용자",
      actorDate: "{actors} · {date}",
      actorsMore: "{first} 외 {count}명",
      noChanges: "상세 변경 내용이 기록되지 않았습니다.",
      changesCount: "변경 {count}건",
      summaryPageCreated: "페이지 생성",
      summaryPageFields: "페이지: {fields}",
      summaryBlocksCreated: "블록 {count}개 추가",
      summaryBlocksUpdated: "블록 {count}개 수정",
      summaryBlocksDeleted: "블록 {count}개 삭제",
      summaryBlocksMoved: "블록 {count}개 이동",
      blockCreated: "블록 추가",
      blockDeleted: "블록 삭제",
      blockUpdated: "블록 수정",
      blockLabel: "{type} 블록",
      ...
      fieldIcon: "아이콘",
      fieldCoverUrl: "커버",
      fieldCoverPositionX: "커버 가로 위치",
      fieldCoverPositionY: "커버 세로 위치",
      fieldIsArchived: "보관 여부",
      fieldIsCollection: "컬렉션 여부",
      fieldParentPageId: "상위 페이지",
      fieldTags: "태그",
      fieldParentBlockId: "상위 블록",
      fieldType: "블록 유형",
      fieldMarkdown: "내용",
      fieldChecked: "체크 여부",
      fieldSortOrder: "순서",
      fieldMetadata: "구조화 데이터"
    },
    sharing: {
      button: "공유",
      kicker: "실시간 공동 편집",
      title: "이 페이지 공유",
      description: "BrainVault 로그인 ID로 사용자를 추가하세요. 공유 사용자는 이 페이지를 실시간으로 함께 편집할 수 있습니다.",
      close: "공유 창 닫기",
      usernameLabel: "사용자 로그인 ID",
      usernamePlaceholder: "사용자 ID",
      add: "사용자 추가",
      remove: "제거",
      peopleWithAccess: "접근 권한이 있는 사용자",
      count: "공유 사용자 {count}명",
      none: "현재는 나만 이 페이지에 접근할 수 있습니다.",
      owner: "소유자",
      editor: "편집 가능",
      adding: "사용자를 추가하는 중입니다...",
      added: "@{username} 사용자가 이제 이 페이지를 편집할 수 있습니다.",
      removing: "@{username} 사용자를 제거하는 중입니다...",
      removed: "@{username} 사용자의 접근 권한을 제거했습니다.",
      loading: "공유 사용자를 불러오는 중입니다...",
      status: {
        connecting: "연결 중",
        syncing: "동기화 중",
        synced: "실시간 연결됨",
    ...
    aiChat: {
      ...
      titlePlaceholder: "AI 대화 블록 제목",
      titleAria: "AI 대화 블록 제목",
      ...
      modelNotSet: "모델명 미설정",
      layoutLabel: "표시 방식",
      layoutAria: "AI 대화 표시 방식",
      layoutStacked: "연속",
      layoutPaginated: "페이지",
      hideAnswerBorder: "AI 답변 테두리 숨기기",
      paginationAria: "AI 대화 페이지",
      pageAria: "{count}번째 질문·답변 쌍 보기",
      timeLabel: "답변 일시",
      timeAria: "AI가 답변한 날짜와 시간",
      timeAriaNumbered: "{count}번째 AI 답변 날짜와 시간",
      timeNotSet: "답변 일시 미설정",
      turnLabel: "대화 {count}",
      addTurn: "+ 다음 질문·답변 추가",
      addTurnTitle: "다음 질문과 답변 쌍 추가",
      removeTurnNumbered: "{count}번째 질문·답변 쌍 삭제",
      questionLabel: "질문",
    ...
    slash: {
      ...
      AI_CHAT: { label: "AI 대화", hint: "연속 질문과 AI 답변 쌍을 채팅 말풍선으로 저장", keywords: "ai chat conversation 질문 답변 모델 프롬프트 대화" },
    ...
    database: {
      ...
      optionsTooMany: "속성에는 최대 {count}개의 옵션만 사용할 수 있습니다. 저장하지 않았습니다.",
      optionNameTooLong: "옵션 이름은 최대 {count}자까지 사용할 수 있습니다. 저장하지 않았습니다.",
      duplicateOption: "중복 옵션: {option}. 저장하지 않았습니다.",
      ambiguousOptionEdit: "기존 행 값을 보존할 수 있도록 옵션 이름은 한 번에 하나씩 변경하세요.",
      referencedOptionRemoval: "행 또는 필터에서 {option} 옵션을 사용 중이므로 제거할 수 없습니다.",
      invalidOptions: "데이터 손실 위험 없이 이 옵션을 저장할 수 없습니다.",
    ...
    kanban: {
      ...
      tagsAria: "카드 태그",
      tooManyTags: "카드에는 최대 {count}개의 태그만 사용할 수 있습니다. 저장하지 않았습니다.",
      tagTooLong: "각 태그는 최대 {count}자까지 사용할 수 있습니다. 저장하지 않았습니다.",
      duplicateTags: "중복 태그는 사용할 수 없습니다. 저장하지 않았습니다.",
    ...
    status: {
      ...
      creatingSubpage: "하위 페이지를 만드는 중입니다...",
      subpageCreated: "하위 페이지를 만들었습니다.",
      ...
      durableRecoveryStorageUnavailable: "엄격한 브라우저 복구 저장소를 사용할 수 없거나 쓰기에 실패해 쓰기 모드를 비활성화했습니다. 새 편집 내용은 반영되지 않았습니다.",
      sessionRecoveryStorageActive: "엄격한 세션 복구 저장소를 사용해 쓰기 모드를 활성화했습니다. 영구 브라우저 저장소는 허용되지 않았으므로 시크릿/프라이빗 세션을 닫으면 로컬 장애 복구 데이터가 삭제될 수 있습니다. 닫기 전에 저장 또는 동기화하세요.",
      localRecoveryInspectionFailed: "브라우저 복구 저장소를 안전하게 확인할 수 없어 파괴적 변경을 실행하지 않았습니다. 관련 탭을 모두 열어 둔 채 다시 시도하세요.",
      exclusiveTransitionLockUnavailable: "이 안전 필수 작업에는 브라우저의 탭 간 잠금 API가 필요하지만 현재 환경에서는 사용할 수 없습니다. 파괴적 변경은 실행되지 않았습니다. HTTPS에서 지원되는 브라우저로 다시 시도하세요.",
      ...
      orphanedCollaborationRecovery: "삭제되었거나 열 수 없거나 공동 편집이 해제된 페이지의 서버 미확인 실시간 편집을 보존했습니다. 브라우저 저장소를 지우기 전에 아래의 읽을 수 있는 복구 데이터를 복사하세요.",
      serverRecoveryCandidates: "복구 사본이 서버에 안전하게 보관되어 있습니다. 복구 보관함에서 삭제하기 전에 필요한 사본을 다운로드하세요.",
      destructiveCollaborationRecoveryPending: "영향받는 페이지에 대해 서버가 확인하지 않은 실시간 편집 복구본 {count}개가 이 브라우저에 남아 있어 작업을 진행할 수 없습니다. 관련 탭을 다시 연결해 동기화를 완료한 뒤 다시 시도하세요.",
      workspaceLocalDraftsPending: "소유한 페이지의 저장되지 않은 로컬 초안 {count}개가 이 브라우저에 남아 있어 백업을 만들 수 없습니다. 관련 탭에서 저장을 완료한 뒤 다시 시도하세요.",
      destructiveLocalDraftsPending: "영향받는 페이지의 저장되지 않은 로컬 초안 {count}개가 이 브라우저에 남아 있어 작업을 진행할 수 없습니다. 관련 탭에서 저장을 완료한 뒤 다시 시도하세요.",
      workspaceTransitionBusy: "다른 탭에서 작업공간을 삭제하거나 복원하는 작업이 진행 중입니다. 완료된 뒤 다시 시도하세요.",
      ready: "준비되었습니다.",
    ...
    errors: {
      ...
      requestTimeout: "서버 응답이 너무 오래 걸렸습니다. 읽기 요청을 자동으로 다시 시도했지만 시간 초과되었습니다. 다시 시도해 주세요.",
      ...
      COUNTRY_LOGIN_BLOCKED: "현재 IP 국가에서는 이 계정에 로그인하거나 접근할 수 없습니다.",
      COUNTRY_POLICY_WOULD_BLOCK_CURRENT_IP: "이 설정을 저장하면 현재 IP가 즉시 차단됩니다. 현재 국가가 허용되도록 국가 목록을 조정하세요.",
      VPN_ACCESS_BLOCKED: "이 계정은 VPN, 프록시 또는 Tor를 통한 접속을 차단하고 있습니다.",
      VPN_POLICY_WOULD_BLOCK_CURRENT_IP: "이 설정을 켜면 현재 IP가 즉시 차단됩니다. VPN/프록시 연결을 해제한 뒤 활성화하세요.",
      ...
      TOTP_IP_PERMANENTLY_BLOCKED: "TOTP 인증 코드를 설정 횟수 이상 틀려 현재 IP가 영구 차단되었습니다. 다른 네트워크에서 로그인한 뒤 보안 > TOTP 차단 IP에서 직접 해제하세요.",
      TOTP_IP_BLOCK_NOT_FOUND: "해당 TOTP 영구 차단 IP가 이미 해제되었거나 존재하지 않습니다.",
      ...
      PAGE_VERSION_RESET_CONFLICT: "다른 창이나 기기에서 페이지 또는 버전 기록이 변경되었습니다. 새 기록은 초기화되지 않았습니다. 새로 고친 기록을 확인한 뒤 다시 시도하세요.",
  ...
  fr: {
    ...
    account: {
      ...
      preferencesTitle: "Préférences", preferencesDescription: "Choisissez l’apparence et le comportement de BrainVault pour votre compte.", languageTitle: "Langue", languageDescription: "Utilisez cette langue à chaque connexion.", themeTitle: "Thème", themeDescription: "Choisissez le thème de couleurs de tout l’espace de travail.", themeLight: "Clair", themeDark: "Sombre",
      securityTitle: "Sécurité", securityDescription: "Gérez les méthodes d’authentification et consultez les tentatives d’accès récentes.", securityTabsAria: "Rubriques de sécurité", securitySettingsTab: "Paramètres de sécurité", loginHistoryTab: "Historique de connexion", loginHistoryTitle: "Historique de connexion", loginHistoryDescription: "Consultez les tentatives de connexion récentes réussies ou échouées sur votre compte.", loginHistoryRefresh: "Actualiser", loginHistoryPeriod: "Période", loginHistoryMonths: "{count} derniers mois", loginHistoryTableCaption: "Tentatives de connexion récentes", loginHistoryTime: "Date et heure", loginHistoryIp: "Adresse IP", loginHistoryCountry: "Pays", loginHistoryUnknownCountry: "Inconnu", loginHistoryResult: "Résultat", loginHistorySuccess: "Réussie", loginHistoryFailure: "Échouée", loginHistoryLocked: "Verrouillée", loginHistoryUnknownIp: "Inconnue", loginHistoryLoading: "Chargement de l’historique...", loginHistoryEmpty: "Aucune tentative de connexion n’a été enregistrée sur cette période.", loginHistoryTruncated: "Seules les 500 tentatives les plus récentes sont affichées.", loginHistorySummary: "{months} derniers mois · {count} tentative(s)", blockHistoryTab: "Historique des blocages", blockHistoryTitle: "Historique des blocages", blockHistoryDescription: "Consultez les connexions refusées par les politiques de pays ou de VPN/proxy.", blockHistoryRefresh: "Actualiser", blockHistoryPeriod: "Période", blockHistoryMonths: "{count} derniers mois", blockHistoryTableCaption: "Blocages récents par politique de sécurité", blockHistoryReason: "Motif", blockHistoryLoading: "Chargement des blocages...", blockHistoryEmpty: "Aucun blocage de sécurité sur cette période.", blockHistoryTruncated: "Seuls les 500 blocages les plus récents sont affichés.", blockHistorySummary: "{months} derniers mois · {count} blocage(s)", blockHistoryNotAllowlisted: "Pays non autorisé", blockHistoryBlacklisted: "Pays bloqué", blockHistoryCountryUnresolved: "Pays indéterminé", blockHistoryPolicyInvalid: "Politique invalide", blockHistoryVpnDetected: "VPN détecté", blockHistoryVpnGateDetected: "Relais public VPN Gate détecté", blockHistoryProxyDetected: "Proxy détecté", blockHistoryTorDetected: "Sortie Tor détectée", countryLoginTitle: "Accès de connexion par pays IP", countryLoginDescription: "Autorisez ou refusez la connexion selon le pays déterminé à partir de l’IP cliente approuvée.", countryLoginMode: "Mode d’accès", countryLoginOff: "Désactivé", countryLoginAllowlist: "Liste autorisée uniquement", countryLoginBlocklist: "Liste bloquée", countryLoginCountry: "Pays", countryLoginAdd: "Ajouter", countryLoginCountryHint: "Ajoutez les pays utilisés par le mode sélectionné.", countryLoginCurrentIp: "IP actuelle", countryLoginCurrentCountry: "Pays actuel", countryLoginPassword: "Mot de passe actuel pour enregistrer", countryLoginWarning: "Si activé, la connexion est refusée lorsque le pays de l’IP ne peut pas être déterminé. L’enregistrement révoque aussi les autres sessions actives.", countryLoginSave: "Enregistrer la politique", countryLoginNoCountries: "Aucun pays sélectionné.", countryLoginRemove: "Supprimer {country}", countryLoginCountriesRequired: "Sélectionnez au moins un pays avant d’activer cette politique.", countryLoginLoading: "Chargement de la politique...", countryLoginSaving: "Enregistrement...", countryLoginSaved: "La politique d’accès par pays a été mise à jour.", vpnBlockTitle: "Blocage VPN / proxy", vpnBlockDescription: "Bloquez l’accès au compte depuis des adresses identifiées avec une forte confiance comme VPN, proxy ou sortie Tor.", vpnBlockMode: "Blocage VPN", vpnBlockOn: "Activé", vpnBlockOff: "Désactivé", vpnBlockCurrentIp: "IP actuelle", vpnBlockCurrentCountry: "Pays actuel", vpnBlockCurrentVerdict: "Évaluation réseau", vpnBlockCurrentSignals: "Signaux complémentaires", vpnBlockRiskClear: "Aucun signal VPN/proxy", vpnBlockRiskVpn: "VPN détecté", vpnBlockRiskVpnGate: "Relais VPN Gate détecté", vpnBlockRiskProxy: "Proxy détecté", vpnBlockRiskTor: "Sortie Tor détectée", vpnBlockRiskUnknown: "Indisponible ou ambigu", vpnBlockRiskWithConfidence: "{risk} · confiance {confidence} %", vpnBlockProviderCount: "{count} source(s)", vpnBlockDatacenterSignal: "Réseau de centre de données", vpnBlockTimezoneSignal: "Décalage de fuseau navigateur/IP", vpnBlockWebRtcMatchSignal: "L’IP STUN WebRTC correspond à l’IP HTTP", vpnBlockWebRtcMismatchSignal: "L’IP STUN WebRTC diffère de l’IP HTTP ({ips})", vpnBlockWebRtcDisabledSignal: "WebRTC est désactivé", vpnBlockWebRtcUnavailableSignal: "Observation STUN WebRTC indisponible", vpnBlockVpnGateListed: "Correspondance avec l’annuaire public VPN Gate", vpnBlockVpnGateDdnsVerified: "Relais VPN Gate + DDNS opengw.net vérifié", vpnBlockVpnGateProviderCorroborated: "Relais VPN Gate + renseignement IP corroboré", vpnBlockVpnGateUnverified: "Correspondance VPN Gate non vérifiée indépendamment", vpnBlockNoSupportingSignals: "Aucun signal complémentaire", vpnBlockPassword: "Mot de passe actuel pour enregistrer", vpnBlockWarning: "La détection utilise des services gratuits sans clé et la liste des sorties Tor. Le centre de données et le fuseau du navigateur ne sont que des signaux complémentaires ; un résultat ambigu n’est pas bloqué. Enregistrer révoque les autres sessions actives.", vpnBlockSave: "Enregistrer le blocage VPN", vpnBlockLoading: "Analyse du réseau...", vpnBlockSaving: "Enregistrement...", vpnBlockSaved: "La politique de blocage VPN a été mise à jour.", passwordTitle: "Mot de passe", passwordDescription: "Confirmez votre mot de passe actuel avant d’en choisir un nouveau.", currentPassword: "Mot de passe actuel", newPassword: "Nouveau mot de passe", confirmPassword: "Confirmer le nouveau mot de passe", passwordHint: "Utilisez au moins 8 caractères, sans dépasser 72 octets en UTF-8.", changePassword: "Modifier le mot de passe",
      preparingAvatar: "Préparation de votre photo de profil...", avatarReady: "Votre nouvelle photo est prête à être enregistrée.", avatarRemoved: "La photo sera supprimée lors de l’enregistrement.", invalidAvatar: "Choisissez une image PNG, JPG ou WebP valide.", avatarTooLarge: "L’image est trop volumineuse. Choisissez un fichier de moins de 5 Mo.", savingProfile: "Enregistrement du profil...", profileSaved: "Votre profil a été mis à jour.", savingLanguage: "Enregistrement de la langue...", savingTheme: "Enregistrement du thème...", themeSaved: "Le thème de l’espace de travail a été mis à jour.", passwordMismatch: "Les nouveaux mots de passe ne correspondent pas.", changingPassword: "Modification du mot de passe...", passwordChanged: "Votre mot de passe a été modifié."
    ,
      dataTitle: "Données",
      dataDescription: "Exportez ou restaurez tout votre espace BrainVault.",
      exportTitle: "Exporter toutes les données",
      exportDescription: "Téléchargez les pages, collections, blocs, étiquettes, autorisations de partage, historique des versions, état de navigation, réglages du profil et toutes les pièces jointes dans une sauvegarde ZIP.",
      ...
      importWarning: "La restauration remplace l’état actuel de l’espace de travail de ce compte, y compris les pages, blocs, associations d’étiquettes, autorisations de partage, historique des versions, état de navigation et pièces jointes.",
      ...
      importConfirm: "Restaurer cette sauvegarde ? L’état actuel de l’espace de travail, y compris l’historique des versions, l’état de navigation, les autorisations de partage et les pièces jointes, sera remplacé.",
      importComplete: "Restauration terminée : {pages} pages, {blocks} blocs, {attachments} pièces jointes, {shares} autorisations de partage, {pageVersions} entrées d’historique et {navigationCollapsedPages} éléments de navigation repliés."
    },
    search: {
    ...
    sharing: {
      button: "Partager",
      kicker: "Collaboration en temps réel",
      title: "Partager cette page",
      description: "Ajoutez un utilisateur BrainVault avec son identifiant de connexion. Les utilisateurs invités peuvent modifier cette page avec vous en temps réel.",
      close: "Fermer la fenêtre de partage",
      usernameLabel: "Identifiant de connexion",
      usernamePlaceholder: "nom d’utilisateur",
      add: "Ajouter l’utilisateur",
      remove: "Retirer",
      peopleWithAccess: "Personnes ayant accès",
      count: "{count} utilisateur(s) invité(s)",
      none: "Vous seul pouvez accéder à cette page.",
      owner: "Propriétaire",
      editor: "Peut modifier",
      adding: "Ajout de l’utilisateur...",
      added: "@{username} peut maintenant modifier cette page.",
      removing: "Retrait de @{username}...",
      removed: "@{username} n’a plus accès à cette page.",
      loading: "Chargement des utilisateurs invités...",
      status: {
      ...
      activeEditors: "{count} collaborateur(s) actif(s)",
      remoteEditing: "{name} modifie la page",
      syncRequired: "Attendez la fin de la synchronisation du document en temps réel.",
      accessChanged: "Votre accès à cette page partagée a changé."
    },
    menu: {
    ...
    kanban: {
      ...
      tooManyTags: "Une carte peut contenir au maximum {count} tags. Rien n’a été enregistré.",
      tagTooLong: "Chaque tag peut contenir au maximum {count} caractères. Rien n’a été enregistré.",
      duplicateTags: "Les tags en double ne sont pas autorisés. Rien n’a été enregistré.",
    ...
    status: {
      ...
      creatingSubpage: "Création de la sous-page...",
      ...
      durableRecoveryStorageUnavailable: "Le mode édition est désactivé car le stockage de récupération strict du navigateur est indisponible ou a échoué. Aucune nouvelle modification n’a été acceptée.",
      sessionRecoveryStorageActive: "Le mode édition est activé avec un stockage de récupération de session strict. Le stockage persistant n’a pas été accordé ; les données locales de récupération peuvent donc être effacées à la fermeture d’une session privée. Enregistrez ou synchronisez avant de la fermer.",
      localRecoveryInspectionFailed: "Le stockage de récupération du navigateur n’a pas pu être vérifié en toute sécurité. Aucune modification destructive n’a été effectuée. Gardez tous les onglets concernés ouverts et réessayez.",
      exclusiveTransitionLockUnavailable: "Cette opération critique pour la sécurité nécessite l’API de verrouillage inter-onglets du navigateur, indisponible ici. Aucune modification destructive n’a été effectuée. Utilisez un navigateur compatible via HTTPS et réessayez.",
      ...
      orphanedCollaborationRecovery: "Les modifications en temps réel non confirmées d’une page supprimée, indisponible ou qui n’est plus collaborative ont été conservées. Copiez les données de récupération lisibles ci-dessous avant d’effacer le stockage du navigateur.",
      serverRecoveryCandidates: "Les copies de récupération sont conservées en toute sécurité sur le serveur. Téléchargez celles dont vous avez besoin avant de les supprimer du coffre de récupération.",
      destructiveCollaborationRecoveryPending: "Cette opération est bloquée car {count} enregistrement(s) de récupération en temps réel non confirmé(s) restent dans ce navigateur pour les pages concernées. Reconnectez tous les onglets associés et terminez la synchronisation.",
      workspaceLocalDraftsPending: "La sauvegarde est bloquée car {count} brouillon(s) local(aux) non enregistré(s) de pages détenues restent dans ce navigateur. Terminez l’enregistrement dans tous les onglets concernés.",
      destructiveLocalDraftsPending: "Cette opération est bloquée car {count} brouillon(s) local(aux) non enregistré(s) des pages concernées restent dans ce navigateur. Terminez l’enregistrement dans tous les onglets concernés.",
      workspaceTransitionBusy: "Un autre onglet supprime ou restaure les données de l’espace de travail. Réessayez une fois l’opération terminée.",
      ready: "Prêt.",
    ...
    errors: {
      ...
      requestTimeout: "Le serveur a mis trop de temps à répondre. La requête de lecture a été réessayée automatiquement, mais a de nouveau expiré. Réessayez.",
      ...
      COUNTRY_LOGIN_BLOCKED: "Le pays de votre IP actuelle n’est pas autorisé à se connecter ou à accéder à ce compte.",
      COUNTRY_POLICY_WOULD_BLOCK_CURRENT_IP: "Cette politique bloquerait immédiatement votre IP actuelle. Modifiez les pays sélectionnés avant d’enregistrer.",
      VPN_ACCESS_BLOCKED: "L’accès par VPN, proxy ou Tor est bloqué pour ce compte.",
      VPN_POLICY_WOULD_BLOCK_CURRENT_IP: "Cette politique bloquerait immédiatement votre IP actuelle. Déconnectez le VPN/proxy avant de l’activer.",
  ...
  de: {
    ...
    account: {
      ...
      preferencesTitle: "Voreinstellungen", preferencesDescription: "Lege Darstellung und Verhalten von BrainVault für dein Konto fest.", languageTitle: "Sprache", languageDescription: "Diese Sprache bei jeder Anmeldung verwenden.", themeTitle: "Design", themeDescription: "Wähle das Farbschema für den gesamten Arbeitsbereich.", themeLight: "Hell", themeDark: "Dunkel",
      securityTitle: "Sicherheit", securityDescription: "Verwalte Anmeldemethoden und prüfe die letzten Zugriffsversuche auf dein Konto.", securityTabsAria: "Sicherheitsbereiche", securitySettingsTab: "Sicherheitseinstellungen", loginHistoryTab: "Anmeldeverlauf", loginHistoryTitle: "Anmeldeverlauf", loginHistoryDescription: "Prüfe die letzten erfolgreichen und fehlgeschlagenen Anmeldeversuche für dein Konto.", loginHistoryRefresh: "Aktualisieren", loginHistoryPeriod: "Zeitraum", loginHistoryMonths: "Letzte {count} Monat(e)", loginHistoryTableCaption: "Letzte Anmeldeversuche", loginHistoryTime: "Zeitpunkt", loginHistoryIp: "IP-Adresse", loginHistoryCountry: "Land", loginHistoryUnknownCountry: "Unbekannt", loginHistoryResult: "Ergebnis", loginHistorySuccess: "Erfolgreich", loginHistoryFailure: "Fehlgeschlagen", loginHistoryLocked: "Gesperrt", loginHistoryUnknownIp: "Unbekannt", loginHistoryLoading: "Anmeldeverlauf wird geladen...", loginHistoryEmpty: "In diesem Zeitraum wurden keine Anmeldeversuche aufgezeichnet.", loginHistoryTruncated: "Es werden nur die letzten 500 Versuche angezeigt.", loginHistorySummary: "Letzte {months} Monat(e) · {count} Versuch(e)", blockHistoryTab: "Sperrverlauf", blockHistoryTitle: "Sperrverlauf", blockHistoryDescription: "Prüfe Anmeldungen und authentifizierte Zugriffe, die durch Länder- oder VPN/Proxy-Richtlinien abgelehnt wurden.", blockHistoryRefresh: "Aktualisieren", blockHistoryPeriod: "Zeitraum", blockHistoryMonths: "Letzte {count} Monat(e)", blockHistoryTableCaption: "Letzte Sicherheitsrichtlinien-Sperren", blockHistoryReason: "Grund", blockHistoryLoading: "Sperrverlauf wird geladen...", blockHistoryEmpty: "In diesem Zeitraum wurden keine Sicherheitsrichtlinien-Sperren aufgezeichnet.", blockHistoryTruncated: "Es werden nur die letzten 500 Sperren angezeigt.", blockHistorySummary: "Letzte {months} Monat(e) · {count} Sperre(n)", blockHistoryNotAllowlisted: "Land nicht erlaubt", blockHistoryBlacklisted: "Gesperrtes Land", blockHistoryCountryUnresolved: "Land nicht ermittelbar", blockHistoryPolicyInvalid: "Ungültige Richtlinie", blockHistoryVpnDetected: "VPN erkannt", blockHistoryVpnGateDetected: "Öffentliches VPN-Gate-Relay erkannt", blockHistoryProxyDetected: "Proxy erkannt", blockHistoryTorDetected: "Tor-Ausgang erkannt", countryLoginTitle: "IP-Länderzugriff für Anmeldungen", countryLoginDescription: "Erlaube oder verweigere Anmeldungen anhand des Landes der vertrauenswürdigen Client-IP.", countryLoginMode: "Zugriffsmodus", countryLoginOff: "Aus", countryLoginAllowlist: "Nur Positivliste", countryLoginBlocklist: "Sperrliste", countryLoginCountry: "Land", countryLoginAdd: "Hinzufügen", countryLoginCountryHint: "Füge Länder für den gewählten Modus hinzu.", countryLoginCurrentIp: "Aktuelle IP", countryLoginCurrentCountry: "Aktuelles Land", countryLoginPassword: "Aktuelles Passwort zum Speichern", countryLoginWarning: "Wenn aktiviert, wird die Anmeldung auch abgelehnt, wenn das IP-Land nicht ermittelt werden kann. Beim Speichern werden andere aktive Sitzungen widerrufen.", countryLoginSave: "Länderrichtlinie speichern", countryLoginNoCountries: "Keine Länder ausgewählt.", countryLoginRemove: "{country} entfernen", countryLoginCountriesRequired: "Wähle mindestens ein Land, bevor du die Richtlinie aktivierst.", countryLoginLoading: "Länderrichtlinie wird geladen...", countryLoginSaving: "Wird gespeichert...", countryLoginSaved: "Die Länderzugriffsrichtlinie wurde aktualisiert.", vpnBlockTitle: "VPN-/Proxy-Zugriff sperren", vpnBlockDescription: "Sperrt Kontozugriffe von IPs, die mit hoher Sicherheit als VPN, Proxy oder Tor-Ausgang erkannt werden.", vpnBlockMode: "VPN-Sperre", vpnBlockOn: "Ein", vpnBlockOff: "Aus", vpnBlockCurrentIp: "Aktuelle IP", vpnBlockCurrentCountry: "Aktuelles Land", vpnBlockCurrentVerdict: "Netzwerkbewertung", vpnBlockCurrentSignals: "Zusatzsignale", vpnBlockRiskClear: "Kein VPN/Proxy-Signal", vpnBlockRiskVpn: "VPN erkannt", vpnBlockRiskVpnGate: "VPN-Gate-Relay erkannt", vpnBlockRiskProxy: "Proxy erkannt", vpnBlockRiskTor: "Tor-Ausgang erkannt", vpnBlockRiskUnknown: "Nicht verfügbar oder uneindeutig", vpnBlockRiskWithConfidence: "{risk} · Vertrauen {confidence} %", vpnBlockProviderCount: "{count} Quelle(n)", vpnBlockDatacenterSignal: "Rechenzentrumsnetz", vpnBlockTimezoneSignal: "Browser/IP-Zeitzonenabweichung", vpnBlockWebRtcMatchSignal: "WebRTC-STUN-IP stimmt mit HTTP-IP überein", vpnBlockWebRtcMismatchSignal: "WebRTC-STUN-IP weicht von HTTP-IP ab ({ips})", vpnBlockWebRtcDisabledSignal: "WebRTC ist deaktiviert", vpnBlockWebRtcUnavailableSignal: "WebRTC-STUN-Beobachtung nicht verfügbar", vpnBlockVpnGateListed: "Treffer im öffentlichen VPN-Gate-Verzeichnis", vpnBlockVpnGateDdnsVerified: "VPN-Gate-Relay + opengw.net-DDNS bestätigt", vpnBlockVpnGateProviderCorroborated: "VPN-Gate-Relay + IP-Intelligence bestätigt", vpnBlockVpnGateUnverified: "VPN-Gate-Verzeichnistreffer nicht unabhängig bestätigt", vpnBlockNoSupportingSignals: "Keine Zusatzsignale", vpnBlockPassword: "Aktuelles Passwort zum Speichern", vpnBlockWarning: "Die Erkennung nutzt kostenlose Dienste ohne API-Schlüssel und die Tor-Ausgangsliste. Rechenzentrum und Browser-Zeitzone dienen nur als Zusatzsignale; uneindeutige Ergebnisse werden nicht gesperrt. Beim Speichern werden andere aktive Sitzungen widerrufen.", vpnBlockSave: "VPN-Sperrrichtlinie speichern", vpnBlockLoading: "Netzwerk wird geprüft...", vpnBlockSaving: "Wird gespeichert...", vpnBlockSaved: "Die VPN-Sperrrichtlinie wurde aktualisiert.", passwordTitle: "Passwort", passwordDescription: "Bestätige dein aktuelles Passwort, bevor du ein neues wählst.", currentPassword: "Aktuelles Passwort", newPassword: "Neues Passwort", confirmPassword: "Neues Passwort bestätigen", passwordHint: "Verwende mindestens 8 Zeichen und höchstens 72 UTF-8-Bytes.", changePassword: "Passwort ändern",
      preparingAvatar: "Profilfoto wird vorbereitet...", avatarReady: "Das neue Profilfoto kann gespeichert werden.", avatarRemoved: "Das Profilfoto wird beim Speichern entfernt.", invalidAvatar: "Wähle ein gültiges PNG-, JPG- oder WebP-Bild.", avatarTooLarge: "Das Bild ist zu groß. Wähle eine Datei unter 5 MB.", savingProfile: "Profil wird gespeichert...", profileSaved: "Dein Profil wurde aktualisiert.", savingLanguage: "Spracheinstellung wird gespeichert...", savingTheme: "Designeinstellung wird gespeichert...", themeSaved: "Das Design des Arbeitsbereichs wurde aktualisiert.", passwordMismatch: "Die neuen Passwörter stimmen nicht überein.", changingPassword: "Passwort wird geändert...", passwordChanged: "Dein Passwort wurde geändert."
    ,
      dataTitle: "Daten",
      ...
      exportDescription: "Lade Seiten, Sammlungen, Blöcke, Tags, Freigabeberechtigungen, Versionsverlauf, Navigationszustand, Profileinstellungen und alle Anhänge in einer ZIP-Sicherung herunter.",
      ...
      importWarning: "Die Wiederherstellung ersetzt den aktuellen Arbeitsbereichszustand dieses Kontos, einschließlich Seiten, Blöcken, Tag-Verknüpfungen, Freigabeberechtigungen, Versionsverlauf, Navigationszustand und Anhängen.",
      ...
      importConfirm: "Diese Sicherung wiederherstellen? Der aktuelle Arbeitsbereichszustand einschließlich Versionsverlauf, Navigationszustand, Freigabeberechtigungen und Anhängen wird ersetzt.",
      importComplete: "Wiederherstellung abgeschlossen: {pages} Seiten, {blocks} Blöcke, {attachments} Anhänge, {shares} Freigabeberechtigungen, {pageVersions} Verlaufseinträge und {navigationCollapsedPages} eingeklappte Navigationseinträge."
    },
    search: {
    ...
    sharing: {
      button: "Teilen",
      kicker: "Zusammenarbeit in Echtzeit",
      title: "Diese Seite teilen",
      description: "Fügen Sie einen BrainVault-Benutzer über die Anmelde-ID hinzu. Freigegebene Benutzer können diese Seite in Echtzeit mit Ihnen bearbeiten.",
      close: "Freigabedialog schließen",
      usernameLabel: "Anmelde-ID des Benutzers",
      usernamePlaceholder: "Benutzername",
      add: "Benutzer hinzufügen",
      remove: "Entfernen",
      peopleWithAccess: "Personen mit Zugriff",
      count: "{count} freigegebene Benutzer",
      none: "Nur Sie können auf diese Seite zugreifen.",
      owner: "Eigentümer",
      editor: "Darf bearbeiten",
      adding: "Benutzer wird hinzugefügt...",
      added: "@{username} kann diese Seite jetzt bearbeiten.",
      removing: "@{username} wird entfernt...",
      removed: "@{username} hat keinen Zugriff mehr.",
      loading: "Freigegebene Benutzer werden geladen...",
      status: {
      ...
      activeEditors: "{count} aktive Mitbearbeiter",
      remoteEditing: "{name} bearbeitet",
      syncRequired: "Warten Sie, bis das Echtzeitdokument vollständig synchronisiert ist.",
      accessChanged: "Ihr Zugriff auf diese freigegebene Seite hat sich geändert."
    },
    menu: {
    ...
    kanban: {
      ...
      tooManyTags: "Eine Karte kann höchstens {count} Tags enthalten. Es wurde nichts gespeichert.",
      tagTooLong: "Jeder Tag darf höchstens {count} Zeichen enthalten. Es wurde nichts gespeichert.",
      duplicateTags: "Doppelte Tags sind nicht erlaubt. Es wurde nichts gespeichert.",
    ...
    status: {
      ...
      creatingSubpage: "Unterseite wird erstellt...",
      ...
      durableRecoveryStorageUnavailable: "Der Bearbeitungsmodus ist deaktiviert, weil strikter Browser-Wiederherstellungsspeicher nicht verfügbar ist oder fehlgeschlagen ist. Es wurde keine neue Änderung angenommen.",
      sessionRecoveryStorageActive: "Der Bearbeitungsmodus ist mit strikt geschriebenem Sitzungsspeicher für die Wiederherstellung aktiviert. Dauerhafter Browserspeicher wurde nicht gewährt; beim Schließen einer privaten Sitzung können lokale Wiederherstellungsdaten gelöscht werden. Vorher speichern oder synchronisieren.",
      localRecoveryInspectionFailed: "Der Wiederherstellungsspeicher des Browsers konnte nicht sicher geprüft werden. Es wurde keine destruktive Änderung ausgeführt. Lass alle betroffenen Tabs geöffnet und versuche es erneut.",
      exclusiveTransitionLockUnavailable: "Dieser sicherheitskritische Vorgang benötigt die tabübergreifende Sperr-API des Browsers, die hier nicht verfügbar ist. Es wurde keine destruktive Änderung ausgeführt. Verwende einen unterstützten Browser über HTTPS und versuche es erneut.",
      ...
      orphanedCollaborationRecovery: "Unbestätigte Echtzeitänderungen für eine gelöschte, nicht verfügbare oder nicht mehr gemeinsam bearbeitete Seite wurden bewahrt. Kopiere die lesbaren Wiederherstellungsdaten unten, bevor du den Browserspeicher löschst.",
      serverRecoveryCandidates: "Wiederherstellungskopien sind sicher auf dem Server gespeichert. Lade benötigte Kopien herunter, bevor du sie aus dem Wiederherstellungstresor entfernst.",
      destructiveCollaborationRecoveryPending: "Dieser Vorgang ist blockiert, weil für die betroffenen Seiten noch {count} unbestätigte Echtzeit-Wiederherstellungseinträge in diesem Browser vorhanden sind. Verbinde alle zugehörigen Tabs erneut und schließe die Synchronisierung ab.",
      workspaceLocalDraftsPending: "Die Sicherung ist blockiert, weil noch {count} nicht gespeicherte lokale Entwürfe für eigene Seiten in diesem Browser vorhanden sind. Schließe das Speichern in allen zugehörigen Tabs ab.",
      destructiveLocalDraftsPending: "Dieser Vorgang ist blockiert, weil noch {count} nicht gespeicherte lokale Entwürfe für betroffene Seiten in diesem Browser vorhanden sind. Schließe das Speichern in allen zugehörigen Tabs ab.",
      workspaceTransitionBusy: "Ein anderer Tab löscht oder stellt gerade Arbeitsbereichsdaten wieder her. Versuche es nach Abschluss des Vorgangs erneut.",
      ready: "Bereit.",
    ...
    errors: {
      ...
      requestTimeout: "Der Server hat zu lange nicht geantwortet. Die Leseanfrage wurde automatisch wiederholt, ist aber erneut abgelaufen. Versuche es noch einmal.",
      ...
      COUNTRY_LOGIN_BLOCKED: "Das Land deiner aktuellen IP darf sich nicht bei diesem Konto anmelden oder darauf zugreifen.",
      COUNTRY_POLICY_WOULD_BLOCK_CURRENT_IP: "Diese Richtlinie würde deine aktuelle IP sofort sperren. Passe die Länderauswahl vor dem Speichern an.",
      VPN_ACCESS_BLOCKED: "VPN-, Proxy- oder Tor-Zugriff ist für dieses Konto gesperrt.",
      VPN_POLICY_WOULD_BLOCK_CURRENT_IP: "Diese Richtlinie würde deine aktuelle IP sofort sperren. Trenne VPN/Proxy vor dem Aktivieren.",
  ...
  es: {
    ...
    account: {
      ...
      preferencesTitle: "Preferencias", preferencesDescription: "Elige cómo se muestra y funciona BrainVault para tu cuenta.", languageTitle: "Idioma", languageDescription: "Usa este idioma cada vez que inicies sesión.", themeTitle: "Tema", themeDescription: "Elige el tema de color de todo el espacio de trabajo.", themeLight: "Claro", themeDark: "Oscuro",
      securityTitle: "Seguridad", securityDescription: "Administra los métodos de autenticación y revisa los intentos recientes de acceso a tu cuenta.", securityTabsAria: "Secciones de seguridad", securitySettingsTab: "Ajustes de seguridad", loginHistoryTab: "Historial de inicio", loginHistoryTitle: "Historial de inicio de sesión", loginHistoryDescription: "Revisa los intentos recientes de inicio de sesión correctos y fallidos de tu cuenta.", loginHistoryRefresh: "Actualizar", loginHistoryPeriod: "Periodo", loginHistoryMonths: "Últimos {count} mes(es)", loginHistoryTableCaption: "Intentos recientes de inicio de sesión", loginHistoryTime: "Fecha y hora", loginHistoryIp: "Dirección IP", loginHistoryCountry: "País", loginHistoryUnknownCountry: "Desconocido", loginHistoryResult: "Resultado", loginHistorySuccess: "Correcto", loginHistoryFailure: "Fallido", loginHistoryLocked: "Bloqueado", loginHistoryUnknownIp: "Desconocida", loginHistoryLoading: "Cargando el historial...", loginHistoryEmpty: "No se registraron intentos de inicio de sesión en este periodo.", loginHistoryTruncated: "Solo se muestran los 500 intentos más recientes.", loginHistorySummary: "Últimos {months} mes(es) · {count} intento(s)", blockHistoryTab: "Historial de bloqueos", blockHistoryTitle: "Historial de bloqueos", blockHistoryDescription: "Revisa accesos rechazados por políticas de país o de VPN/proxy.", blockHistoryRefresh: "Actualizar", blockHistoryPeriod: "Periodo", blockHistoryMonths: "Últimos {count} mes(es)", blockHistoryTableCaption: "Bloqueos recientes por política de seguridad", blockHistoryReason: "Motivo", blockHistoryLoading: "Cargando bloqueos...", blockHistoryEmpty: "No hubo bloqueos de seguridad en este periodo.", blockHistoryTruncated: "Solo se muestran los 500 bloqueos más recientes.", blockHistorySummary: "Últimos {months} mes(es) · {count} bloqueo(s)", blockHistoryNotAllowlisted: "País no permitido", blockHistoryBlacklisted: "País bloqueado", blockHistoryCountryUnresolved: "País no determinado", blockHistoryPolicyInvalid: "Política no válida", blockHistoryVpnDetected: "VPN detectada", blockHistoryVpnGateDetected: "Relay público de VPN Gate detectado", blockHistoryProxyDetected: "Proxy detectado", blockHistoryTorDetected: "Salida Tor detectada", countryLoginTitle: "Acceso de inicio por país de IP", countryLoginDescription: "Permite o rechaza el inicio de sesión según el país obtenido de la IP cliente de confianza.", countryLoginMode: "Modo de acceso", countryLoginOff: "Desactivado", countryLoginAllowlist: "Solo lista permitida", countryLoginBlocklist: "Lista bloqueada", countryLoginCountry: "País", countryLoginAdd: "Añadir", countryLoginCountryHint: "Añade los países usados por el modo seleccionado.", countryLoginCurrentIp: "IP actual", countryLoginCurrentCountry: "País actual", countryLoginPassword: "Contraseña actual para guardar", countryLoginWarning: "Si se activa, el inicio de sesión se rechaza cuando no se puede determinar el país de la IP. Guardar también revoca las demás sesiones activas.", countryLoginSave: "Guardar política", countryLoginNoCountries: "No hay países seleccionados.", countryLoginRemove: "Quitar {country}", countryLoginCountriesRequired: "Selecciona al menos un país antes de activar esta política.", countryLoginLoading: "Cargando política...", countryLoginSaving: "Guardando...", countryLoginSaved: "La política de acceso por país se actualizó.", vpnBlockTitle: "Bloqueo de VPN / proxy", vpnBlockDescription: "Bloquea el acceso a la cuenta desde IP identificadas con alta confianza como VPN, proxy o salida Tor.", vpnBlockMode: "Bloqueo VPN", vpnBlockOn: "Activado", vpnBlockOff: "Desactivado", vpnBlockCurrentIp: "IP actual", vpnBlockCurrentCountry: "País actual", vpnBlockCurrentVerdict: "Evaluación de red", vpnBlockCurrentSignals: "Señales auxiliares", vpnBlockRiskClear: "Sin señal de VPN/proxy", vpnBlockRiskVpn: "VPN detectada", vpnBlockRiskVpnGate: "Relay de VPN Gate detectado", vpnBlockRiskProxy: "Proxy detectado", vpnBlockRiskTor: "Salida Tor detectada", vpnBlockRiskUnknown: "No disponible o ambiguo", vpnBlockRiskWithConfidence: "{risk} · confianza {confidence} %", vpnBlockProviderCount: "{count} fuente(s)", vpnBlockDatacenterSignal: "Red de centro de datos", vpnBlockTimezoneSignal: "Diferencia de zona horaria navegador/IP", vpnBlockWebRtcMatchSignal: "La IP STUN de WebRTC coincide con la IP HTTP", vpnBlockWebRtcMismatchSignal: "La IP STUN de WebRTC difiere de la IP HTTP ({ips})", vpnBlockWebRtcDisabledSignal: "WebRTC está desactivado", vpnBlockWebRtcUnavailableSignal: "Observación STUN de WebRTC no disponible", vpnBlockVpnGateListed: "Coincidencia con el directorio público de VPN Gate", vpnBlockVpnGateDdnsVerified: "Relay VPN Gate + DDNS opengw.net verificado", vpnBlockVpnGateProviderCorroborated: "Relay VPN Gate + inteligencia IP corroborada", vpnBlockVpnGateUnverified: "Coincidencia VPN Gate sin verificación independiente", vpnBlockNoSupportingSignals: "Sin señales auxiliares", vpnBlockPassword: "Contraseña actual para guardar", vpnBlockWarning: "La detección usa inteligencia de red gratuita sin clave y la lista de salidas Tor. El centro de datos y la zona horaria del navegador son solo señales auxiliares; los resultados ambiguos no se bloquean. Guardar revoca las demás sesiones activas.", vpnBlockSave: "Guardar bloqueo VPN", vpnBlockLoading: "Evaluando la red...", vpnBlockSaving: "Guardando...", vpnBlockSaved: "La política de bloqueo VPN se actualizó.", passwordTitle: "Contraseña", passwordDescription: "Confirma tu contraseña actual antes de elegir una nueva.", currentPassword: "Contraseña actual", newPassword: "Nueva contraseña", confirmPassword: "Confirmar nueva contraseña", passwordHint: "Usa al menos 8 caracteres y como máximo 72 bytes UTF-8.", changePassword: "Cambiar contraseña",
      preparingAvatar: "Preparando tu foto de perfil...", avatarReady: "La nueva foto está lista para guardarse.", avatarRemoved: "La foto se eliminará al guardar.", invalidAvatar: "Elige una imagen PNG, JPG o WebP válida.", avatarTooLarge: "La imagen es demasiado grande. Elige un archivo de menos de 5 MB.", savingProfile: "Guardando el perfil...", profileSaved: "Tu perfil se actualizó.", savingLanguage: "Guardando la preferencia de idioma...", savingTheme: "Guardando la preferencia de tema...", themeSaved: "Se actualizó el tema del espacio de trabajo.", passwordMismatch: "Las nuevas contraseñas no coinciden.", changingPassword: "Cambiando la contraseña...", passwordChanged: "Tu contraseña se cambió."
    ,
      dataTitle: "Datos",
      dataDescription: "Exporta o restaura todo tu espacio de BrainVault.",
      exportTitle: "Exportar todos los datos",
      exportDescription: "Descarga páginas, colecciones, bloques, etiquetas, permisos de uso compartido, historial de versiones, estado de navegación, ajustes del perfil y todos los archivos adjuntos en una copia ZIP.",
      ...
      importWarning: "La restauración reemplaza el estado actual del espacio de trabajo de esta cuenta, incluidas páginas, bloques, relaciones de etiquetas, permisos de uso compartido, historial de versiones, estado de navegación y archivos adjuntos.",
      ...
      importConfirm: "¿Restaurar esta copia? Se reemplazará el estado actual del espacio de trabajo, incluido el historial de versiones, el estado de navegación, los permisos de uso compartido y los archivos adjuntos.",
      importComplete: "Restauración completada: {pages} páginas, {blocks} bloques, {attachments} archivos adjuntos, {shares} permisos de uso compartido, {pageVersions} entradas de historial y {navigationCollapsedPages} elementos de navegación contraídos."
    },
    search: {
    ...
    sharing: {
      button: "Compartir",
      kicker: "Colaboración en tiempo real",
      title: "Compartir esta página",
      description: "Añade un usuario de BrainVault por su ID de inicio de sesión. Los usuarios compartidos pueden editar esta página contigo en tiempo real.",
      close: "Cerrar el cuadro de compartir",
      usernameLabel: "ID de inicio de sesión",
      usernamePlaceholder: "nombre de usuario",
      add: "Añadir usuario",
      remove: "Quitar",
      peopleWithAccess: "Personas con acceso",
      count: "{count} usuario(s) compartido(s)",
      none: "Solo tú puedes acceder a esta página.",
      owner: "Propietario",
      editor: "Puede editar",
      adding: "Añadiendo usuario...",
      added: "@{username} ya puede editar esta página.",
      removing: "Quitando a @{username}...",
      removed: "@{username} ya no tiene acceso.",
      loading: "Cargando usuarios compartidos...",
      status: {
      ...
      activeEditors: "{count} colaborador(es) activo(s)",
      remoteEditing: "{name} está editando",
      syncRequired: "Espera a que termine la sincronización del documento en tiempo real.",
      accessChanged: "Tu acceso a esta página compartida ha cambiado."
    },
    menu: {
    ...
    kanban: {
      ...
      tooManyTags: "Una tarjeta puede contener como máximo {count} etiquetas. No se guardó nada.",
      tagTooLong: "Cada etiqueta puede contener como máximo {count} caracteres. No se guardó nada.",
      duplicateTags: "No se permiten etiquetas duplicadas. No se guardó nada.",
    ...
    status: {
      ...
      creatingSubpage: "Creando una subpágina...",
      ...
      durableRecoveryStorageUnavailable: "El modo de edición está desactivado porque el almacenamiento estricto de recuperación del navegador no está disponible o ha fallado. No se aceptó ninguna edición nueva.",
      sessionRecoveryStorageActive: "El modo de edición está habilitado con almacenamiento estricto de recuperación de sesión. No se concedió almacenamiento persistente; los datos locales de recuperación pueden borrarse al cerrar una sesión privada o de incógnito. Guarda o sincroniza antes de cerrarla.",
      localRecoveryInspectionFailed: "No se pudo inspeccionar de forma segura el almacenamiento de recuperación del navegador. No se realizó ningún cambio destructivo. Mantén abiertas todas las pestañas relacionadas e inténtalo de nuevo.",
      exclusiveTransitionLockUnavailable: "Esta operación crítica para la seguridad requiere la API de bloqueo entre pestañas del navegador, que no está disponible aquí. No se realizó ningún cambio destructivo. Usa un navegador compatible mediante HTTPS e inténtalo de nuevo.",
      ...
      orphanedCollaborationRecovery: "Se conservaron ediciones en tiempo real no confirmadas de una página eliminada, no disponible o que ya no admite colaboración. Copia los datos de recuperación legibles de abajo antes de borrar el almacenamiento del navegador.",
      serverRecoveryCandidates: "Las copias de recuperación están guardadas de forma segura en el servidor. Descarga las que necesites antes de eliminarlas de la bóveda de recuperación.",
      destructiveCollaborationRecoveryPending: "Esta operación está bloqueada porque quedan {count} registro(s) de recuperación en tiempo real sin confirmar para las páginas afectadas en este navegador. Vuelve a conectar todas las pestañas relacionadas y termina la sincronización.",
      workspaceLocalDraftsPending: "La copia de seguridad está bloqueada porque quedan {count} borrador(es) local(es) sin guardar de páginas propias en este navegador. Termina de guardar en todas las pestañas relacionadas.",
      destructiveLocalDraftsPending: "Esta operación está bloqueada porque quedan {count} borrador(es) local(es) sin guardar de las páginas afectadas en este navegador. Termina de guardar en todas las pestañas relacionadas.",
      workspaceTransitionBusy: "Otra pestaña está eliminando o restaurando datos del espacio de trabajo. Inténtalo de nuevo cuando termine la operación.",
      ready: "Listo.",
    ...
    errors: {
      ...
      requestTimeout: "El servidor tardó demasiado en responder. La solicitud de lectura se reintentó automáticamente, pero volvió a agotar el tiempo de espera. Inténtalo de nuevo.",
      ...
      COUNTRY_LOGIN_BLOCKED: "El país de tu IP actual no tiene permiso para iniciar sesión ni acceder a esta cuenta.",
      COUNTRY_POLICY_WOULD_BLOCK_CURRENT_IP: "Esta política bloquearía inmediatamente tu IP actual. Ajusta los países seleccionados antes de guardar.",
      VPN_ACCESS_BLOCKED: "El acceso por VPN, proxy o Tor está bloqueado para esta cuenta.",
      VPN_POLICY_WOULD_BLOCK_CURRENT_IP: "Esta política bloquearía inmediatamente tu IP actual. Desconecta la VPN/proxy antes de activarla.",
  ...
  pt: {
    ...
    account: {
      ...
      preferencesTitle: "Preferências", preferencesDescription: "Escolha como o BrainVault aparece e funciona para sua conta.", languageTitle: "Idioma", languageDescription: "Use este idioma sempre que entrar.", themeTitle: "Tema", themeDescription: "Escolha o tema de cores de todo o espaço de trabalho.", themeLight: "Claro", themeDark: "Escuro",
      securityTitle: "Segurança", securityDescription: "Gerencie os métodos de autenticação e revise tentativas recentes de acesso à sua conta.", securityTabsAria: "Seções de segurança", securitySettingsTab: "Configurações de segurança", loginHistoryTab: "Histórico de login", loginHistoryTitle: "Histórico de login", loginHistoryDescription: "Revise tentativas recentes de login bem-sucedidas e malsucedidas da sua conta.", loginHistoryRefresh: "Atualizar", loginHistoryPeriod: "Período", loginHistoryMonths: "Últimos {count} mês(es)", loginHistoryTableCaption: "Tentativas recentes de login", loginHistoryTime: "Data e hora", loginHistoryIp: "Endereço IP", loginHistoryCountry: "País", loginHistoryUnknownCountry: "Desconhecido", loginHistoryResult: "Resultado", loginHistorySuccess: "Sucesso", loginHistoryFailure: "Falha", loginHistoryLocked: "Bloqueado", loginHistoryUnknownIp: "Desconhecido", loginHistoryLoading: "Carregando o histórico...", loginHistoryEmpty: "Nenhuma tentativa de login foi registrada neste período.", loginHistoryTruncated: "Apenas as 500 tentativas mais recentes são exibidas.", loginHistorySummary: "Últimos {months} mês(es) · {count} tentativa(s)", blockHistoryTab: "Histórico de bloqueios", blockHistoryTitle: "Histórico de bloqueios", blockHistoryDescription: "Revise acessos negados por políticas de país ou VPN/proxy.", blockHistoryRefresh: "Atualizar", blockHistoryPeriod: "Período", blockHistoryMonths: "Últimos {count} mês(es)", blockHistoryTableCaption: "Bloqueios recentes por política de segurança", blockHistoryReason: "Motivo", blockHistoryLoading: "Carregando bloqueios...", blockHistoryEmpty: "Nenhum bloqueio de segurança foi registrado neste período.", blockHistoryTruncated: "Apenas os 500 bloqueios mais recentes são exibidos.", blockHistorySummary: "Últimos {months} mês(es) · {count} bloqueio(s)", blockHistoryNotAllowlisted: "País não permitido", blockHistoryBlacklisted: "País bloqueado", blockHistoryCountryUnresolved: "País não identificado", blockHistoryPolicyInvalid: "Política inválida", blockHistoryVpnDetected: "VPN detectada", blockHistoryVpnGateDetected: "Relay público do VPN Gate detectado", blockHistoryProxyDetected: "Proxy detectado", blockHistoryTorDetected: "Saída Tor detectada", countryLoginTitle: "Acesso de login por país do IP", countryLoginDescription: "Permita ou negue o login conforme o país identificado pela IP confiável do cliente.", countryLoginMode: "Modo de acesso", countryLoginOff: "Desativado", countryLoginAllowlist: "Somente lista permitida", countryLoginBlocklist: "Lista bloqueada", countryLoginCountry: "País", countryLoginAdd: "Adicionar", countryLoginCountryHint: "Adicione os países usados pelo modo selecionado.", countryLoginCurrentIp: "IP atual", countryLoginCurrentCountry: "País atual", countryLoginPassword: "Senha atual para salvar", countryLoginWarning: "Quando ativado, o login também é negado se o país do IP não puder ser identificado. Salvar também revoga as outras sessões ativas.", countryLoginSave: "Salvar política", countryLoginNoCountries: "Nenhum país selecionado.", countryLoginRemove: "Remover {country}", countryLoginCountriesRequired: "Selecione pelo menos um país antes de ativar esta política.", countryLoginLoading: "Carregando política...", countryLoginSaving: "Salvando...", countryLoginSaved: "A política de acesso por país foi atualizada.", vpnBlockTitle: "Bloqueio de VPN / proxy", vpnBlockDescription: "Bloqueie o acesso à conta a partir de IPs identificados com alta confiança como VPN, proxy ou saída Tor.", vpnBlockMode: "Bloqueio VPN", vpnBlockOn: "Ativado", vpnBlockOff: "Desativado", vpnBlockCurrentIp: "IP atual", vpnBlockCurrentCountry: "País atual", vpnBlockCurrentVerdict: "Avaliação de rede", vpnBlockCurrentSignals: "Sinais auxiliares", vpnBlockRiskClear: "Sem sinal de VPN/proxy", vpnBlockRiskVpn: "VPN detectada", vpnBlockRiskVpnGate: "Relay do VPN Gate detectado", vpnBlockRiskProxy: "Proxy detectado", vpnBlockRiskTor: "Saída Tor detectada", vpnBlockRiskUnknown: "Indisponível ou ambíguo", vpnBlockRiskWithConfidence: "{risk} · confiança {confidence}%", vpnBlockProviderCount: "{count} fonte(s)", vpnBlockDatacenterSignal: "Rede de datacenter", vpnBlockTimezoneSignal: "Diferença de fuso navegador/IP", vpnBlockWebRtcMatchSignal: "O IP STUN do WebRTC corresponde ao IP HTTP", vpnBlockWebRtcMismatchSignal: "O IP STUN do WebRTC difere do IP HTTP ({ips})", vpnBlockWebRtcDisabledSignal: "WebRTC está desativado", vpnBlockWebRtcUnavailableSignal: "Observação STUN do WebRTC indisponível", vpnBlockVpnGateListed: "Correspondência no diretório público do VPN Gate", vpnBlockVpnGateDdnsVerified: "Relay VPN Gate + DDNS opengw.net verificado", vpnBlockVpnGateProviderCorroborated: "Relay VPN Gate + inteligência de IP corroborada", vpnBlockVpnGateUnverified: "Correspondência VPN Gate sem verificação independente", vpnBlockNoSupportingSignals: "Sem sinais auxiliares", vpnBlockPassword: "Senha atual para salvar", vpnBlockWarning: "A detecção usa inteligência de rede gratuita sem chave e a lista de saídas Tor. Datacenter e fuso do navegador são apenas sinais auxiliares; resultados ambíguos não são bloqueados. Salvar revoga as outras sessões ativas.", vpnBlockSave: "Salvar bloqueio VPN", vpnBlockLoading: "Avaliando a rede...", vpnBlockSaving: "Salvando...", vpnBlockSaved: "A política de bloqueio VPN foi atualizada.", passwordTitle: "Senha", passwordDescription: "Confirme sua senha atual antes de escolher uma nova.", currentPassword: "Senha atual", newPassword: "Nova senha", confirmPassword: "Confirmar nova senha", passwordHint: "Use pelo menos 8 caracteres e no máximo 72 bytes UTF-8.", changePassword: "Alterar senha",
      preparingAvatar: "Preparando sua foto de perfil...", avatarReady: "A nova foto está pronta para ser salva.", avatarRemoved: "A foto será removida ao salvar.", invalidAvatar: "Escolha uma imagem PNG, JPG ou WebP válida.", avatarTooLarge: "A imagem é muito grande. Escolha um arquivo com menos de 5 MB.", savingProfile: "Salvando o perfil...", profileSaved: "Seu perfil foi atualizado.", savingLanguage: "Salvando a preferência de idioma...", savingTheme: "Salvando a preferência de tema...", themeSaved: "O tema do espaço de trabalho foi atualizado.", passwordMismatch: "As novas senhas não coincidem.", changingPassword: "Alterando a senha...", passwordChanged: "Sua senha foi alterada."
    ,
      dataTitle: "Dados",
      dataDescription: "Exporte ou restaure todo o seu espaço do BrainVault.",
      exportTitle: "Exportar todos os dados",
      exportDescription: "Baixe páginas, coleções, blocos, etiquetas, permissões de compartilhamento, histórico de versões, estado de navegação, configurações do perfil e todos os anexos em um backup ZIP.",
      ...
      importWarning: "A restauração substitui o estado atual do espaço de trabalho desta conta, incluindo páginas, blocos, vínculos de etiquetas, permissões de compartilhamento, histórico de versões, estado de navegação e anexos.",
      ...
      importConfirm: "Restaurar este backup? O estado atual do espaço de trabalho, incluindo histórico de versões, estado de navegação, permissões de compartilhamento e anexos, será substituído.",
      importComplete: "Restauração concluída: {pages} páginas, {blocks} blocos, {attachments} anexos, {shares} permissões de compartilhamento, {pageVersions} entradas de histórico e {navigationCollapsedPages} itens de navegação recolhidos."
    },
    search: {
    ...
    sharing: {
      button: "Compartilhar",
      kicker: "Colaboração em tempo real",
      title: "Compartilhar esta página",
      description: "Adicione um usuário do BrainVault pelo ID de login. Usuários compartilhados podem editar esta página com você em tempo real.",
      close: "Fechar diálogo de compartilhamento",
      usernameLabel: "ID de login do usuário",
      usernamePlaceholder: "nome de usuário",
      add: "Adicionar usuário",
      remove: "Remover",
      peopleWithAccess: "Pessoas com acesso",
      count: "{count} usuário(s) compartilhado(s)",
      none: "Somente você pode acessar esta página.",
      owner: "Proprietário",
      editor: "Pode editar",
      adding: "Adicionando usuário...",
      added: "@{username} agora pode editar esta página.",
      removing: "Removendo @{username}...",
      removed: "@{username} não tem mais acesso.",
      loading: "Carregando usuários compartilhados...",
      status: {
        connecting: "Conectando",
        syncing: "Sincronizando",
        synced: "Ao vivo",
      ...
      activeEditors: "{count} colaborador(es) ativo(s)",
      remoteEditing: "{name} está editando",
      syncRequired: "Aguarde a conclusão da sincronização do documento em tempo real.",
      accessChanged: "Seu acesso a esta página compartilhada mudou."
    },
    menu: {
    ...
    kanban: {
      ...
      tooManyTags: "Um cartão pode ter no máximo {count} tags. Nada foi salvo.",
      tagTooLong: "Cada tag pode ter no máximo {count} caracteres. Nada foi salvo.",
      duplicateTags: "Tags duplicadas não são permitidas. Nada foi salvo.",
    ...
    status: {
      ...
      creatingSubpage: "Criando uma subpágina...",
      ...
      durableRecoveryStorageUnavailable: "O modo de edição foi desativado porque o armazenamento estrito de recuperação do navegador está indisponível ou falhou. Nenhuma nova edição foi aceita.",
      sessionRecoveryStorageActive: "O modo de edição está ativado com armazenamento estrito de recuperação da sessão. O armazenamento persistente não foi concedido; os dados locais de recuperação podem ser apagados ao fechar uma sessão privada/anônima. Salve ou sincronize antes de fechá-la.",
      localRecoveryInspectionFailed: "Não foi possível inspecionar com segurança o armazenamento de recuperação do navegador. Nenhuma alteração destrutiva foi realizada. Mantenha todas as abas relacionadas abertas e tente novamente.",
      exclusiveTransitionLockUnavailable: "Esta operação crítica de segurança exige a API de bloqueio entre abas do navegador, que não está disponível aqui. Nenhuma alteração destrutiva foi realizada. Use um navegador compatível via HTTPS e tente novamente.",
      ...
      orphanedCollaborationRecovery: "As edições em tempo real não confirmadas de uma página excluída, indisponível ou que deixou de ser colaborativa foram preservadas. Copie os dados de recuperação legíveis abaixo antes de limpar o armazenamento do navegador.",
      serverRecoveryCandidates: "As cópias de recuperação estão armazenadas com segurança no servidor. Baixe as cópias necessárias antes de removê-las do cofre de recuperação.",
      destructiveCollaborationRecoveryPending: "Esta operação está bloqueada porque ainda existem {count} registro(s) de recuperação em tempo real não confirmado(s) para as páginas afetadas neste navegador. Reconecte todas as abas relacionadas e conclua a sincronização.",
      workspaceLocalDraftsPending: "O backup está bloqueado porque ainda existem {count} rascunho(s) local(is) não salvo(s) de páginas próprias neste navegador. Conclua o salvamento em todas as abas relacionadas.",
      destructiveLocalDraftsPending: "Esta operação está bloqueada porque ainda existem {count} rascunho(s) local(is) não salvo(s) das páginas afetadas neste navegador. Conclua o salvamento em todas as abas relacionadas.",
      workspaceTransitionBusy: "Outra aba está excluindo ou restaurando dados do espaço de trabalho. Tente novamente após a conclusão da operação.",
      ready: "Pronto.",
    ...
    errors: {
      ...
      requestTimeout: "O servidor demorou demais para responder. A solicitação de leitura foi repetida automaticamente, mas excedeu o tempo limite novamente. Tente outra vez.",
      ...
      COUNTRY_LOGIN_BLOCKED: "O país da sua IP atual não tem permissão para entrar ou acessar esta conta.",
      COUNTRY_POLICY_WOULD_BLOCK_CURRENT_IP: "Esta política bloquearia imediatamente sua IP atual. Ajuste os países selecionados antes de salvar.",
      VPN_ACCESS_BLOCKED: "O acesso por VPN, proxy ou Tor está bloqueado para esta conta.",
      VPN_POLICY_WOULD_BLOCK_CURRENT_IP: "Esta política bloquearia imediatamente sua IP atual. Desconecte a VPN/proxy antes de ativá-la.",
...
const pageCommentTranslationAdditions = {
  en: {
    add: "Add comment",
    title: "Comments",
    refresh: "Refresh",
    ...
    empty: "No comments yet. Start the discussion for this page.",
    placeholder: "Add a comment…",
    inputLabel: "Add a page comment",
    submit: "Comment",
    submitting: "Posting…",
    added: "Comment added.",
    edit: "Edit",
  ...
  ja: {
    ...
    count: "コメント {count} 件",
    empty: "まだコメントはありません。このページについて会話を始めましょう。",
    placeholder: "コメントを追加…",
    inputLabel: "ページコメントを追加",
    submit: "コメント",
    submitting: "投稿中…",
    added: "コメントを追加しました。",
    edit: "編集",
  ...
  ko: {
    ...
    loading: "댓글을 불러오는 중…",
    count: "댓글 {count}개",
    empty: "아직 댓글이 없습니다. 이 페이지에 대한 대화를 시작해 보세요.",
    placeholder: "댓글 추가…",
    inputLabel: "페이지 댓글 추가",
    submit: "댓글",
    submitting: "등록 중…",
    added: "댓글을 등록했습니다.",
    edit: "수정",
  ...
  fr: {
    ...
    count: "{count} commentaire(s)",
    empty: "Aucun commentaire pour le moment. Lancez la discussion sur cette page.",
    placeholder: "Ajouter un commentaire…",
    inputLabel: "Ajouter un commentaire à la page",
    submit: "Commenter",
  ...
  de: {
    ...
    count: "{count} Kommentar(e)",
    empty: "Noch keine Kommentare. Starte die Diskussion zu dieser Seite.",
    placeholder: "Kommentar hinzufügen…",
    inputLabel: "Seitenkommentar hinzufügen",
    submit: "Kommentieren",
  ...
  es: {
    ...
    empty: "Aún no hay comentarios. Inicia la conversación sobre esta página.",
    placeholder: "Añadir un comentario…",
    inputLabel: "Añadir un comentario a la página",
    submit: "Comentar",
  ...
  pt: {
    ...
    count: "{count} comentário(s)",
    empty: "Ainda não há comentários. Inicie a conversa sobre esta página.",
    placeholder: "Adicionar um comentário…",
    inputLabel: "Adicionar comentário à página",
    submit: "Comentar",
    submitting: "Publicando…",
    ...
    saved: "Comentário atualizado.",
    deleted: "Comentário excluído.",
    loadError: "Não foi possível carregar os comentários."
  }
};

for (const [language, comments] of Object.entries(pageCommentTranslationAdditions)) {
...
const snapshotAccountTranslationAdditions = {
  en: {
    account: {
      snapshots: "Snapshots",
      snapshotsTitle: "Snapshots",
      snapshotsDescription: "Capture a complete private copy of the current workspace and compare or restore it later.",
      snapshotRefresh: "Refresh",
      snapshotCreateTitle: "Create snapshot",
      snapshotCreateDescription: "Stores the same complete workspace payload as a BrainVault backup, including pages, blocks, tags, sharing, version history, navigation state, attachments, page covers, and uploaded custom icons. Passwords and two-step verification are never included.",
      snapshotCreateButton: "Create snapshot now",
      snapshotListTitle: "Saved snapshots",
      snapshotListDescription: "Compare a snapshot with the current workspace, restore it, or delete it.",
      snapshotEmpty: "No snapshots have been created yet.",
      snapshotLoading: "Loading snapshots...",
      snapshotCount: "{count} saved",
      snapshotItemMeta: "{pages} pages · {blocks} blocks · {attachments} files · {pageVersions} history entries · {size}",
      snapshotIntegrityDigest: "Recorded archive SHA-256 · {digest}…",
      snapshotIntegrityOk: "Stored file available",
      snapshotIntegrityMissing: "Archive missing",
      snapshotIntegritySizeMismatch: "Size mismatch",
      snapshotCreatePending: "Capturing the complete workspace snapshot...",
      snapshotCreated: "Snapshot created and integrity metadata saved.",
      snapshotCompare: "Compare with current",
      snapshotComparing: "Comparing...",
      snapshotCompared: "Snapshot comparison is ready.",
      snapshotRestore: "Restore",
      snapshotDelete: "Delete",
      snapshotRestoreConfirm: "Restore the snapshot from {date}? The current workspace will be replaced, while passwords and two-step verification stay unchanged.",
      snapshotDeleteConfirm: "Permanently delete the snapshot from {date}? This cannot be undone.",
      snapshotRestoring: "Verifying and restoring the snapshot...",
      snapshotRestored: "Snapshot restored: {pages} pages, {blocks} blocks, {attachments} attachments, and {pageVersions} history entries.",
      snapshotDeleting: "Deleting the snapshot...",
      snapshotDeleted: "Snapshot deleted.",
      snapshotIdentical: "This snapshot and the current workspace are identical across the complete compared workspace payload.",
      ...
      snapshotBlockLabel: "{type} block · {id}",
      snapshotBlockSummary: "Blocks +{added} / −{removed} / ~{modified}",
      snapshotUntitledPage: "Untitled page",
      snapshotFieldSnapshot: "Snapshot",
      snapshotFieldCurrent: "Current",
      snapshotValueNone: "None",
      snapshotValueYes: "Yes",
      snapshotValueNo: "No",
      snapshotLongValue: "{excerpt} · {length} chars · SHA-256 {hash}…",
      snapshotFieldTitle: "Title",
      snapshotFieldIcon: "Icon",
      snapshotFieldCover: "Cover",
      snapshotFieldCoverPositionX: "Cover X position",
      snapshotFieldCoverPositionY: "Cover Y position",
      snapshotFieldArchived: "Archived",
      snapshotFieldCollection: "Collection",
      snapshotFieldParentPageId: "Parent page",
      snapshotFieldTags: "Tags",
      snapshotFieldSharedWith: "Shared with",
      snapshotFieldNavigationCollapsed: "Navigation collapsed",
      snapshotFieldNavigationOrder: "Navigation order",
      snapshotFieldHistoryEntries: "Version history entries",
      snapshotFieldCreatedAt: "Created at",
      snapshotFieldUpdatedAt: "Updated at",
      snapshotFieldType: "Block type",
      snapshotFieldParentBlockId: "Parent block",
      snapshotFieldMarkdown: "Block content",
      snapshotFieldChecked: "Checked",
      snapshotFieldSortOrder: "Block order",
      snapshotFieldMetadata: "Block metadata",
      snapshotFieldHtmlCache: "Rendered block cache",
      snapshotFieldEditVersion: "Edit version",
      snapshotFieldContentVersion: "Content version",
      snapshotFieldAttachmentFile: "Attachment file integrity",
      snapshotFieldTagState: "Tag records",
      snapshotFieldSharingState: "Sharing grant records",
      snapshotFieldHistoryData: "Version history data",
      snapshotFieldAccountName: "Account display name",
      snapshotFieldAccountAvatar: "Account avatar",
      snapshotFieldPreferredLanguage: "Preferred language",
      snapshotFieldDefaultCollectionIcon: "Default collection icon",
      snapshotFieldTheme: "Theme",
      snapshotFieldSourceUsername: "Account username",
      snapshotFieldRetainedAttachmentCount: "Retained file count",
      snapshotFieldRetainedAttachments: "Retained file state",
      snapshotFieldCustomIconCount: "Custom icon count",
      snapshotFieldCustomIcons: "Custom icon state",
      snapshotFieldCustomIconRemovals: "Custom icon removal state"
    },
    errors: {
  ...
  ko: {
    account: {
      snapshots: "스냅샷",
      snapshotsTitle: "스냅샷",
      snapshotsDescription: "현재 워크스페이스 전체를 비공개 스냅샷으로 보관하고 나중에 비교하거나 복원할 수 있습니다.",
      snapshotRefresh: "새로고침",
      snapshotCreateTitle: "스냅샷 생성",
      snapshotCreateDescription: "BrainVault 전체 백업과 동일한 범위로 페이지, 블록, 태그, 공유 권한, 버전 기록, 내비게이션 상태, 첨부파일, 페이지 커버, 업로드한 커스텀 아이콘까지 저장합니다. 비밀번호와 2단계 인증 정보는 포함하지 않습니다.",
      snapshotCreateButton: "지금 스냅샷 생성",
      snapshotListTitle: "저장된 스냅샷",
      snapshotListDescription: "현재 워크스페이스와 비교하거나, 해당 시점으로 복원하거나, 삭제할 수 있습니다.",
      snapshotEmpty: "아직 생성된 스냅샷이 없습니다.",
      snapshotLoading: "스냅샷을 불러오는 중...",
      snapshotCount: "{count}개 저장됨",
      snapshotItemMeta: "페이지 {pages}개 · 블록 {blocks}개 · 파일 {attachments}개 · 버전 기록 {pageVersions}개 · {size}",
      snapshotIntegrityDigest: "기록된 압축파일 SHA-256 · {digest}…",
      snapshotIntegrityOk: "저장 파일 확인됨",
      snapshotIntegrityMissing: "압축파일 없음",
      snapshotIntegritySizeMismatch: "크기 불일치",
      snapshotCreatePending: "현재 워크스페이스 전체를 스냅샷으로 저장하는 중...",
      snapshotCreated: "스냅샷 생성 및 무결성 메타데이터 저장이 완료되었습니다.",
      snapshotCompare: "현재와 비교",
      snapshotComparing: "비교 중...",
      snapshotCompared: "스냅샷 비교 결과를 준비했습니다.",
      snapshotRestore: "복원",
      snapshotDelete: "삭제",
      snapshotRestoreConfirm: "{date}의 스냅샷으로 복원할까요? 현재 워크스페이스는 교체되지만 비밀번호와 2단계 인증 정보는 변경되지 않습니다.",
      snapshotDeleteConfirm: "{date}의 스냅샷을 영구 삭제할까요? 이 작업은 되돌릴 수 없습니다.",
      snapshotRestoring: "스냅샷 무결성을 검증하고 복원하는 중...",
      snapshotRestored: "스냅샷 복원이 완료되었습니다: 페이지 {pages}개, 블록 {blocks}개, 첨부파일 {attachments}개, 버전 기록 {pageVersions}개.",
      snapshotDeleting: "스냅샷을 삭제하는 중...",
      snapshotDeleted: "스냅샷을 삭제했습니다.",
      snapshotIdentical: "비교 대상인 전체 워크스페이스 데이터가 현재 상태와 동일합니다.",
      ...
      snapshotBlockLabel: "{type} 블록 · {id}",
      snapshotBlockSummary: "블록 +{added} / −{removed} / ~{modified}",
      snapshotUntitledPage: "제목 없는 페이지",
      snapshotFieldSnapshot: "스냅샷",
      snapshotFieldCurrent: "현재",
      snapshotValueNone: "없음",
      snapshotValueYes: "예",
      snapshotValueNo: "아니요",
      snapshotLongValue: "{excerpt} · {length}자 · SHA-256 {hash}…",
      snapshotFieldTitle: "제목",
      snapshotFieldIcon: "아이콘",
      snapshotFieldCover: "커버",
      snapshotFieldCoverPositionX: "커버 X 위치",
      snapshotFieldCoverPositionY: "커버 Y 위치",
      snapshotFieldArchived: "보관됨",
      snapshotFieldCollection: "컬렉션",
      snapshotFieldParentPageId: "상위 페이지",
      snapshotFieldTags: "태그",
      snapshotFieldSharedWith: "공유 대상",
      snapshotFieldNavigationCollapsed: "내비게이션 접힘",
      snapshotFieldNavigationOrder: "내비게이션 순서",
      snapshotFieldHistoryEntries: "버전 기록 수",
      snapshotFieldCreatedAt: "생성 시각",
      snapshotFieldUpdatedAt: "수정 시각",
      snapshotFieldType: "블록 유형",
      snapshotFieldParentBlockId: "상위 블록",
      snapshotFieldMarkdown: "블록 내용",
      snapshotFieldChecked: "체크 상태",
      snapshotFieldSortOrder: "블록 순서",
      snapshotFieldMetadata: "블록 메타데이터",
      snapshotFieldHtmlCache: "렌더링된 블록 캐시",
      snapshotFieldEditVersion: "편집 버전",
      snapshotFieldContentVersion: "콘텐츠 버전",
      snapshotFieldAttachmentFile: "첨부파일 무결성",
      snapshotFieldTagState: "태그 레코드",
      snapshotFieldSharingState: "공유 권한 레코드",
      snapshotFieldHistoryData: "버전 기록 데이터",
      snapshotFieldAccountName: "계정 표시 이름",
      snapshotFieldAccountAvatar: "계정 아바타",
      snapshotFieldPreferredLanguage: "선호 언어",
      snapshotFieldDefaultCollectionIcon: "기본 컬렉션 아이콘",
      snapshotFieldTheme: "테마",
      snapshotFieldSourceUsername: "계정 사용자명",
      snapshotFieldRetainedAttachmentCount: "보존 파일 수",
      snapshotFieldRetainedAttachments: "보존 파일 상태",
      snapshotFieldCustomIconCount: "커스텀 아이콘 수",
      snapshotFieldCustomIcons: "커스텀 아이콘 상태",
      snapshotFieldCustomIconRemovals: "커스텀 아이콘 삭제 상태"
    },
    errors: {
...
for (const [language, addition] of Object.entries(snapshotAccountTranslationAdditions)) {
  const catalog = translationCatalogs[language];
  if (!catalog) continue;
  Object.assign(catalog.account, addition.account);
  Object.assign(catalog.errors, addition.errors);
}

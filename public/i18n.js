...
export const translationCatalogs = {
  en: {
    ...
    ,
      ...
      exportDescription: "Download pages, collections, blocks, tags, sharing permissions, profile settings, and every attached file in one ZIP backup.",
      ...
      importWarning: "Restoring replaces every current page, collection, block, tag link, sharing permission, and attachment in this account.",
      ...
      importConfirm: "Restore this backup? All current workspace data, sharing permissions, and attachments in this account will be replaced.",
      importComplete: "Restore complete: {pages} pages, {blocks} blocks, {attachments} attachments, and {shares} sharing permissions."
    },
    mfa: {
  ...
  ja: {
    ...
    ,
      ...
      exportDescription: "ページ、コレクション、ブロック、タグ、共有権限、プロフィール設定、添付ファイルを1つのZIPバックアップとしてダウンロードします。",
      exportButton: "ZIPバックアップを書き出す",
      importTitle: "バックアップを復元",
      importDescription: "BrainVaultから書き出したZIPを検証して復元します。パスワードと2段階認証は変更されません。",
      importWarning: "復元すると、このアカウントの現在のページ、コレクション、ブロック、タグ関連付け、共有権限、添付ファイルがすべて置き換わります。",
  ...
  ko: {
    ...
    ,
      ...
      exportDescription: "페이지, 컬렉션, 블록, 태그, 공유 권한, 프로필 설정과 모든 첨부파일 원본을 하나의 ZIP 백업으로 내려받습니다.",
      exportButton: "ZIP 백업 내보내기",
      importTitle: "백업 복원",
      importDescription: "BrainVault에서 내보낸 ZIP 백업을 검증한 뒤 원본 상태로 복원합니다. 비밀번호와 2단계 인증은 변경하지 않습니다.",
      importWarning: "복원하면 이 계정의 현재 페이지, 컬렉션, 블록, 태그 연결, 공유 권한과 첨부파일이 모두 백업 내용으로 교체됩니다.",
      ...
      importConfirm: "이 백업을 복원할까요? 현재 워크스페이스 데이터, 공유 권한과 첨부파일이 모두 교체됩니다.",
      importComplete: "복원이 완료되었습니다: 페이지 {pages}개, 블록 {blocks}개, 첨부파일 {attachments}개, 공유 권한 {shares}개."
    },
    mfa: {
  ...
  fr: {
    ...
    ,
      ...
      exportDescription: "Téléchargez les pages, collections, blocs, étiquettes, autorisations de partage, réglages du profil et toutes les pièces jointes dans une sauvegarde ZIP.",
      ...
      importWarning: "La restauration remplace toutes les pages, collections, blocs, associations d’étiquettes, autorisations de partage et pièces jointes actuelles de ce compte.",
  ...
  de: {
    ...
    ,
      ...
      exportDescription: "Lade Seiten, Sammlungen, Blöcke, Tags, Freigabeberechtigungen, Profileinstellungen und alle Anhänge in einer ZIP-Sicherung herunter.",
      ...
      importWarning: "Die Wiederherstellung ersetzt alle aktuellen Seiten, Sammlungen, Blöcke, Tag-Verknüpfungen, Freigabeberechtigungen und Anhänge dieses Kontos.",
  ...
  es: {
    ...
    ,
      ...
      exportDescription: "Descarga páginas, colecciones, bloques, etiquetas, permisos de uso compartido, ajustes del perfil y todos los archivos adjuntos en una copia ZIP.",
      ...
      importWarning: "La restauración reemplaza todas las páginas, colecciones, bloques, relaciones de etiquetas, permisos de uso compartido y archivos adjuntos actuales de esta cuenta.",
  ...
  pt: {
    ...
    ,
      ...
      exportDescription: "Baixe páginas, coleções, blocos, etiquetas, permissões de compartilhamento, configurações do perfil e todos os anexos em um backup ZIP.",
      ...
      importWarning: "A restauração substitui todas as páginas, coleções, blocos, vínculos de etiquetas, permissões de compartilhamento e anexos atuais desta conta.",

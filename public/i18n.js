...
export const translationCatalogs = {
  en: {
    ...
    account: {
      ...
      totpIpBlockDescription: "Permanently block the client IP after too many invalid authenticator-app codes.",
      ...
      totpIpBlockThresholdHint: "Default: 3. The attempt that reaches this number permanently blocks the IP.",
      totpIpBlockCurrentIp: "Current IP", totpIpBlockPassword: "Current password to save this policy",
      totpIpBlockWarning: "When enabled, invalid TOTP codes are accumulated for the same account and IP until a TOTP succeeds or this policy is changed. Reaching the configured limit permanently denies that IP at the server before the login page or API is served. Existing permanent blocks remain until manually unblocked.",
      ...
      totpIpBlocksDescription: "Use another unblocked network to review and manually release IPs permanently blocked by this account's TOTP attempt limit.",
    ...
    errors: {
      ...
      TOTP_IP_PERMANENTLY_BLOCKED: "This IP address has been permanently blocked after too many invalid TOTP codes. Use another network and manually unblock it from Security > TOTP blocked IPs.",

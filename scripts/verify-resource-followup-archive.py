...
Usage: python scripts/verify-resource-followup-archive.py ORIGINAL.zip FIXED.zip --output result.json
"""
import argparse
import hashlib
import json
...
EXPECTED_ORIGINAL_SHA256 = '332d9ab43bc74f865b0a46f13a02d57cbaf3140ce70f16a9518104cedb73ac50'
EXPECTED_CHANGES = {'public/treeview-block.js', 'src/lib/treeview.ts', 'src/lib/websocket.ts'}

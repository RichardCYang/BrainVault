...
CREATE TABLE IF NOT EXISTS blocks (
  ...
  type ENUM('MARKDOWN', 'HEADING_1', 'HEADING_2', 'HEADING_3', 'HEADING_4', 'HEADING_5', 'TODO', 'UNORDERED_LIST', 'ORDERED_LIST', 'QUOTE', 'CALLOUT', 'TOGGLE', 'ACCORDION', 'TABLE', 'KANBAN', 'DATABASE', 'TREEVIEW', 'TIMETABLE', 'GANTT', 'BOOKMARK', 'AI_CHAT', 'MATH', 'MERMAID', 'CODE', 'DIVIDER', 'IMAGE', 'VIDEO', 'ATTACHMENT') NOT NULL DEFAULT 'MARKDOWN',

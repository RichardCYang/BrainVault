...
const envSchema = z.object({
  ...
  AUTH_PASSKEY_OPTIONS_IP_WINDOW_MS: z.coerce.number().int().positive().default(15 * 60_000),
  AUTH_PASSKEY_OPTIONS_IP_MAX: z.coerce.number().int().positive().default(30),
  AUTH_PASSKEY_VERIFY_IP_WINDOW_MS: z.coerce.number().int().positive().default(15 * 60_000),
  AUTH_PASSKEY_VERIFY_IP_MAX: z.coerce.number().int().positive().default(15),
  ...
  ATTACHMENT_UPLOAD_MAX_CONCURRENT: z.coerce.number().int().min(1).max(32).default(4),
